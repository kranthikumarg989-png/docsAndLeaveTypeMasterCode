...
Partial Public Class er_reportshostel
    ...
    Protected Sub showrepOT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles showrepOT.Click
        ...
        If rb1.SelectedValue = "al" Then
            ...
            If tempstr.ToString.Contains("what") = True Then
                ...
                If lettername.SelectedValue = 11 Then
                    tempstr = "SELECT er_finalwarninghostel.empcode,empmaster.empname,empmaster.departmentcode as Dept,empmaster.sectioncode as Sect, er_finalwarninghostel.letterdate,er_finalwarninghostel.reason  FROM er_finalwarninghostel INNER JOIN  empmaster ON er_finalwarninghostel.empcode = empmaster.empcode  WHERE letterdate >='" & fd & "' AND letterdate <= '" & td & "'"
                End If
                Session("sql") = tempstr
            End If
        ElseIf rb1.SelectedValue = "emp" Then
            ...
            If tempstr.ToString.Contains("what") = True Then
                tempstr = tempstr.ToString.Replace("what", Session("tblname").ToString)
                If lettername.SelectedValue = 11 Then
                    tempstr = "SELECT er_finalwarninghostel.empcode,empmaster.empname,empmaster.departmentcode as Dept,empmaster.sectioncode as Sect, er_finalwarninghostel.letterdate,er_finalwarninghostel.reason FROM er_finalwarninghostel INNER JOIN  empmaster ON er_finalwarninghostel.empcode = empmaster.empcode WHERE letterdate >='" & fd & "' AND letterdate <= '" & td & "'and empcode='" & empcode.Text & "'"
                End If
                Session("sql") = tempstr
            End If
        ElseIf rb1.SelectedValue = "dpt" Then
            ...
            If tempstr.ToString.Contains("what") = True Then
                tempstr = tempstr.ToString.Replace("what", Session("tblname").ToString)
                If lettername.SelectedValue = 11 Then
                    tempstr = "SELECT er_finalwarninghostel.empcode,empmaster.empname,empmaster.departmentcode as Dept,empmaster.sectioncode as Sect, er_finalwarninghostel.letterdate,er_finalwarninghostel.reason from  er_finalwarninghostel INNER JOIN  empmaster ON er_finalwarninghostel.empcode = empmaster.empcode WHERE (empmaster.departmentcode = '" & dept.SelectedValue & "') and (empmaster.resigned <>'Y') and (er_finalwarninghostel.letterdate >= '" & fd & "' and  er_finalwarninghostel.letterdate <= '" & td & "')"
                End If
                Session("sql") = tempstr
            End If
        ElseIf rb1.SelectedValue = "sec" Then
            ...
            If tempstr.ToString.Contains("what") = True Then
                tempstr = tempstr.ToString.Replace("what", Session("tblname").ToString)
                If lettername.SelectedValue = 11 Then
                    tempstr = "SELECT er_finalwarninghostel.empcode,empmaster.empname,empmaster.departmentcode as Dept,empmaster.sectioncode as Sect, er_finalwarninghostel.letterdate,er_finalwarninghostel.reason from  er_finalwarninghostel INNER JOIN  empmaster ON er_finalwarninghostel.empcode = empmaster.empcode WHERE (empmaster.sectioncode = '" & sect.SelectedValue & "') and (empmaster.resigned <>'Y') and (er_finalwarninghostel.letterdate >= '" & fd & "' and  er_finalwarninghostel.letterdate <= '" & td & "')"
                End If
                Session("sql") = tempstr
            End If
        End If
