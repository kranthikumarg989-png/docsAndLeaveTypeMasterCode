                            ...
                            <table>
                                ...
                                <tr>
                                    <td style="width: 277px; height: 22px; background-color: beige">
                                        <asp:Label ID="lbldeptr" runat="server" Text="Choose Leave Type" Font-Bold="False"></asp:Label></td>
                                    <td style="width: 529px; height: 22px">
                                        <asp:DropDownList ID="leavetype" runat="server" Width="258px" AutoPostBack="True">
                                            ...
                                            runat="server" ControlToValidate="leavetype" ErrorMessage="!" InitialValue="-1"
                                            ValidationGroup="a"></asp:RequiredFieldValidator></td>
                                </tr>
                                <tr>
                                    <td style="width: 277px; height: 22px; background-color: beige">
                                        <asp:Label ID="Label2" runat="server" Text="Choose Option"></asp:Label></td>
                                    <td style="width: 529px; height: 22px">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="rdoptions"
                                            ErrorMessage="!" ValidationGroup="a"></asp:RequiredFieldValidator></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="right" colspan="2" style="height: 26px; text-align: center;">
                                        &nbsp;<asp:Button ID="showtTrainingReport" runat="server" SkinID="buttonskin1" Text="SHOW REPORT" ValidationGroup="a" />
                                    </td>
                                </tr>
                            </table>
                            &nbsp; &nbsp;&nbsp;
