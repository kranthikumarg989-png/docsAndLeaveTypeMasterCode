<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="er_reportshostel.aspx.vb" Inherits="E_Management.er_reportshostel" %>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td style="width: 148px; height: 24px; background-color: beige">
                                        Select type</td>
                                    <td style="width: 403px; height: 26px">
                                        <asp:RadioButtonList ID="rb1" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" Width="402px">
                                            ...
                                            <asp:ListItem Selected="True" Value="al">By OverAll</asp:ListItem>
                                ...
                                <tr>
                                    <td style="width: 148px; height: 26px; background-color: beige">
                                        Employee No</td>
                                    <td style="width: 403px; height: 26px">
                                        <asp:TextBox ID="empcode" runat="server" Width="87px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="width: 148px; height: 26px; background-color: beige">
                                        Department</td>
                                ...
                                <tr>
                                    <td style="width: 148px; height: 24px; background-color: beige">
                                        Section</td>
                                    <td style="width: 403px; height: 26px">
                                        <asp:DropDownList ID="sect" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2" DataTextField="Column1" DataValueField="sectioncode">
                                            <asp:ListItem Value="-1">Select</asp:ListItem>
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 403px; height: 26px">
                                        <asp:DropDownList ID="lettername" runat="server">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
