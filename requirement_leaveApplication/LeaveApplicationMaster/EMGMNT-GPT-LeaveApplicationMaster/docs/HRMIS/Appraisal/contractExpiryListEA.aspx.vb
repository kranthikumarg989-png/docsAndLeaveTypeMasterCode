...
Partial Public Class contractExpiryListEA
    ...
    Protected Sub UpdateAppraisal(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For i As Integer = 0 To GridView1.Rows.Count - 1
            ...
            MyGlobal.Con_Str()
            If stats <> "" Then
                DS = emanagement.globalinfo.Open_appraisal(Con, DAP, 2, "update app_operatorappraisal set confirmd = '" & stats & "' , status ='A' where rno='" & slno & "'")
    ...
    Private Sub BindGrid()
        ...
        Command = New SqlCommand("hrmis_getExpcontract_EA1", con)
