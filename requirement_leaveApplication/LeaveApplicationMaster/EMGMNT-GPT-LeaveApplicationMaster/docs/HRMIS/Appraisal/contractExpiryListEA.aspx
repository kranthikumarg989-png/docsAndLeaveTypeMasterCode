<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="contractExpiryListEA.aspx.vb" Inherits="E_Management.contractExpiryListEA" 
    ...
    <table>
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Font-Names="Lucida Sans Unicode" Font-Size="Small"
                    Font-Underline="True" ForeColor="#804000" Text="STAFF CONTRACT EXPIRY LIST" Width="368px"></asp:Label>
                <br />
        ...
        <tr>
            <td><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" PageSize="15">
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    DataSourceID="SqlDataSource2" ForeColor="#333333" ShowFooter="True" Width="834px" Visible="False" Caption="OPERATOR CONTRACT EXPIRY LIST">
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                    <Columns>
                       <asp:BoundField DataField="rno" HeaderText="Rno" SortExpression="rno" />
                        ...
                        <asp:BoundField DataField="empname" HeaderText="Empname" SortExpression="empname" />
                        <asp:BoundField DataField="dateofappraisal" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Appraisal Date"
        ...
        <tr>
            ...
            <asp:SqlDataSource id="SqlDataSource2" runat="server" SelectCommand="SELECT *, empmaster.empname, empmaster.sectioncode, empmaster.departmentcode, empmaster.empcode AS Expr1 FROM app_operatorappraisal INNER JOIN empmaster ON app_operatorappraisal.empcode = empmaster.empcode WHERE (app_operatorappraisal.status = @status) and designation = 'operator' and empmaster.foreignemp = 'Y' and resigned = 'N' order by rno desc" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>">
            <SelectParameters>
            <asp:Parameter DefaultValue="AD" Name="status" Type="String"  />
            </SelectParameters>
            </asp:SqlDataSource>
                
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
         SelectCommand="hrmis_getExpcontract_EA1" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
