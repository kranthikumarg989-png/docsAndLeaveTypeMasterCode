...
Partial Public Class staffappraisal
    ...
    Private Sub Appdetails()
        ...
        con.Open()
        cmd1 = New SqlCommand("select max(dateappraisal) as dt from app_staffappraisal where empcode = '" & txtempcode.Text & "' and (status = 'S' or status ='D')", con)
        ...
        con.Open()
        cmd1 = New SqlCommand("select * from app_staffappraisal where empcode = '" & txtempcode.Text & "' and dateappraisal = '" & Label1.Text & "'", con)
        ...
        While (dra1.Read())
            ...
            rdconfirm.SelectedValue = dra1("confirmed").ToString
    ...
    Protected Sub txtbutton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtbutton.Click
        ...
        Try
            MyGlobal.Open_Con()
            MyGlobal.Con_Str()
            Call MyGlobal.dbSp_open("hrmis_insAppraisal")
            ...
            If Session("foreigner") = "Y" Then
                ...
                If dsemp.Tables(0).Rows.Count <> 0 Then
                    ...
                    Dim dtdiff = dateexp.Subtract(thisdate).Days

                    'If dremp("foreignemp") = "Y" Then
                    '    expalert = 90
                    'Else
                    '    expalert = 30
                    'End If

                    'Call MyGlobal.dbSp_open("insert_contract_payroll")
            ...
            ElseIf Session("foreigner") = "N" Then
                ...
                End While
                fstat = "P"
                Call MyGlobal.dbSp_open("insert_appraisal_hod")
                Cmd.Parameters.AddWithValue("@empcode", txtempcode.Text.Trim)
                Cmd.Parameters.AddWithValue("@appraisal", "Y")
                Cmd.Parameters.AddWithValue("@status", "AD")
