<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="contractExpListHOD.aspx.vb" Inherits="E_Management.contractExpListHOD" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
    <table>
        <tr>
            <td>
                <asp:Label ID="Label4" runat="server" Font-Names="Lucida Sans Unicode" Font-Size="Small"
                    Font-Underline="True" ForeColor="#804000" Text="STAFF CONTRACT EXPIRY LIST" Width="368px"></asp:Label></td>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" PageSize="15">
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                    SelectCommand="hrmis_getExpcontract_hod" SelectCommandType="StoredProcedure">
                    <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
        SelectCommand="hrmis_getExpcontract_hod_POT" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter Name="dept" SessionField="dept" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
