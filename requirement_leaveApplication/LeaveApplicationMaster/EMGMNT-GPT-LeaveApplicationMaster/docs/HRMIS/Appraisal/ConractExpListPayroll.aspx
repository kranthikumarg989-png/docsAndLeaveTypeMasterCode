<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ConractExpListPayroll.aspx.vb" Inherits="E_Management.ConractExpListPayroll" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
    <table>
        ...
        <tr>
            <td>
                <asp:GridView id="GrdContract" runat="server" ForeColor="#333333" PageSize="15" AllowPaging="True" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" CellPadding="4" ShowFooter="True">
                ...
                <ItemTemplate>
                    ...
                    CausesValidation="false" CommandArgument='<%# Eval("empcode", "{0}") %>'
                       ...
                       <asp:TemplateField  HeaderText="PRINT">
                            <ItemTemplate>
                                <asp:LinkButton ID="Link2" runat="server" CausesValidation="false" CommandArgument='<%# Eval("confirmd", "{0}") %>'
                                    ForeColor="BLUE" OnCommand="printappraisal" Text="PRINT"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                          ...
                          <asp:TemplateField HeaderText="Close" SortExpression="Close">
                            ...
                            <ItemTemplate>
                            <asp:RadioButtonList ID="Stat" runat="server" width="75px">
                                    ...
                                    <asp:ListItem Value="N">No</asp:ListItem>
                                      ...
                                      <FooterTemplate>
                                <asp:Button ID="Button1" runat="server" OnClick="Hodapp" Text="CLOSE" />
                            </FooterTemplate>                     
        ...
        <tr>
            <td>
                <asp:GridView id="GridView1" runat="server" ForeColor="#333333" PageSize="15" AllowPaging="True" DataSourceID="SqlDataSource2" AutoGenerateColumns="False" CellPadding="4" ShowFooter="True">
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333"  />
                    <Columns>
                           <asp:TemplateField HeaderText="Empcode" SortExpression="empcode">
                <EditItemTemplate>
                ...
                <ItemTemplate>
                    ...
                    CausesValidation="false" CommandArgument='<%# Eval("empcode", "{0}") %>'
                        ...
                        <asp:TemplateField  HeaderText="PRINT">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButto" runat="server" CausesValidation="false" CommandArgument='<%# Eval("confirmd", "{0}") %>'
                                    ForeColor="BLUE" OnCommand="printappraisal" Text="PRINT"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                            ...
                            <ItemTemplate>
                            <asp:RadioButtonList ID="Stat2" runat="server" width="75px">
                                    <asp:ListItem Value="C">Yes</asp:ListItem>
                                    <asp:ListItem Value="N">No</asp:ListItem>
                                      ...
                                      <FooterTemplate>
                                <asp:Button ID="Button2" runat="server" OnClick="Hodapp2" Text="CLOSE" />
                            </FooterTemplate>                     
