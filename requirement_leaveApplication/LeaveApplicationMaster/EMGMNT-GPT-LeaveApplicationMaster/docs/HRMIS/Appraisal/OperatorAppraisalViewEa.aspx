<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="OperatorAppraisalViewEa.aspx.vb" Inherits="E_Management.OperatorAppraisalViewEa" 
    title="Operator Appraisal View" %>
                        ...
                        <td vAlign="top" bgColor="#ffffff" style="width: 650px">
                         <table>
                          ...
                          <tr>
                             ...
                             <tr>
                                 <td colspan="4" style="height: 21px; background-color: beige" align="left" valign="top">
                                     <table>
                                         <tr>
                                             <td style="width: 84px">
                                                 SH comment</td>
                             ...
                             <tr>
                                 <td colspan="4" style="height: 21px; background-color: beige">
                                     <asp:TextBox ID="txtea" runat="server" TextMode="MultiLine" Width="608px" Visible="False"></asp:TextBox></td>
                             </tr>
                             <tr>
                                 <td colspan="4" style="height: 21px; background-color: beige">
                                 </td>
