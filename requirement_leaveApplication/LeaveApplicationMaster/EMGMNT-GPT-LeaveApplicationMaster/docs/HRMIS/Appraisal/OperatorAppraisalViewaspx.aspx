<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="OperatorAppraisalViewaspx.aspx.vb" Inherits="E_Management.OperatorAppraisalViewaspx" 
                    ...
                    <tr>
                        ...
                        <td vAlign="top" bgColor="#ffffff" style="width: 650px">
                         <table>
                             ...
                             <tr>
                                 <td char="td_head" colspan="4" style="height: 17px">
                             ...
                             <tr>
                                 <td colspan="4" style="height: 21px; background-color: beige">
                                     Department Head &nbsp;Comments</td>
                             </tr>
                             <tr>
                                 <td colspan="4" style="height: 21px; background-color: beige">
                                     <asp:TextBox ID="txtdh" runat="server" TextMode="MultiLine" Width="625px"></asp:TextBox></td>
                             </tr>
                             <tr>
