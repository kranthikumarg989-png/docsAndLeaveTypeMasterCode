...
Partial Public Class EaAppraisal
    Inherits System.Web.UI.Page
    Dim MyGlobal As New emanagement.globalinfo
    Dim MyApp As New emanagement.EMSapplications
    Dim empcode
    Private Sub EaAppraisal_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Private Sub appdetails()
        ...
        con.Open()
        cmd1 = New SqlCommand("select max(dateappraisal) as dt from app_staffappraisal where empcode = '" & txtempcode.Text & "'", con)
