<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="staffappraisal.aspx.vb" Inherits="E_Management.staffappraisal" 
                    ...
                    <tr>
                        ...
                        <td vAlign="top" bgColor="#ffffff" style="width: 650px">
                         <table>
                             ...
                             <tr>
                                 <td style="width: 80px; background-color: beige; height: 21px;">
                             ...
                             <tr>
                                 <td colspan="4" style="height: 21px; background-color: beige">
                                     <asp:GridView ID="grdJg" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow"
                                         ...
                                         GridLines="Vertical" Visible="False" Width="100%" ShowFooter="True">
                                         <Columns>
                                             ...
                                             <asp:TemplateField HeaderText="Weightage">
                                                 <ItemTemplate>
                                                     <asp:TextBox ID="pweight" runat="server" Width="41px" AutoPostBack=true OnTextChanged="Calculatetotal" ></asp:TextBox>%
                                                 </ItemTemplate>
                                                 <FooterTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="Refer (PRI) above and Grade">
                                                 <ItemTemplate>
                                                     <asp:RadioButtonList ID="rdprating" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="chkDynamic_CheckedChanged">
                             ...
                             <tr>
                                 <td colspan="4" style="background-color: beige" align="left" valign="top">
                                     <asp:GridView ID="GrdPerformance" runat="server" AutoGenerateColumns="False" DataSourceID="sqlperformance" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" Width="100%" ShowFooter="True">
                                         <Columns>
                                             <asp:BoundField DataField="sno" HeaderText="sno" SortExpression="sno" />
                                             ...
                                             <asp:TemplateField HeaderText="Weightage">
                                                 <ItemTemplate>
                                                     <asp:TextBox ID="txtbweit" runat="server" Width="41px" AutoPostBack=true OnTextChanged="Calculatetotal2" ></asp:TextBox>%
                                                 </ItemTemplate>
                                                     <FooterTemplate>
                                 ...
                                 <td colspan="4" style="height: 21px; background-color: beige" align="right">
                                  ...
                                  <asp:SqlDataSource ID="Sqljs" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                                     ...
                                     <asp:SqlDataSource ID="sqlperformance" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                                         SelectCommand="SELECT  [sno], [per],title FROM [app_charsettingtemp] ORDER BY [sno]">
                                     </asp:SqlDataSource>
                                  </td>
