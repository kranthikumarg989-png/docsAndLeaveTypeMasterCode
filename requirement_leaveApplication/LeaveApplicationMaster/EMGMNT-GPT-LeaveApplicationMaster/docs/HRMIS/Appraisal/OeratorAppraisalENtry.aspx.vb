...
Partial Public Class OeratorAppraisalENtry
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ' lblempcode.Text = "014543" & "-" & "ravi Vamshi anigalla"
    ...
    Protected Sub txtempcode_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtempcode.TextChanged
        ...
        con.Open()
        cmd1 = New SqlCommand("select max(CONVERT(varchar(10), dateofappraisal, 101)) as dt from app_operatorappraisal where empcode = '" & txtempcode.Text & "' and status = 'AS'", con)
        ...
        con.Open()
        cmd1 = New SqlCommand("select * from app_operatorappraisal where empcode = '" & txtempcode.Text & "' and dateofappraisal = '" & fd & "'", con)
        ...
        sqltext = "select * from performancedatainput where year1='" & tnyr & "' and empcode = '" & txtempcode.Text.Trim & "'"
        Dim emp
        Dim options
        Dim tot
        Dim grd
    ...
    Protected Sub txtbutton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtbutton.Click
        ...
        Try
            MyGlobal.Open_Con()
            MyGlobal.Con_Str()
            Call MyGlobal.dbSp_open("Hrmis_insOptappraisal_entry")
