...
Public Class manresignjoin
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_View_Pm_empmasterempcode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedmanresignjoin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As manresignjoin = New manresignjoin
        rpt.Site = Me.Site
        Return rpt
    End Function
