<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="jobapplication.aspx.vb" Inherits="E_Management.jobapplication" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
   <table cellpadding="0" cellspacing="0" width="100%">
    ...
    <table>
        ...
        <tr>
            <td bgcolor="beige" width="25%">I/C New no</td>
            <td width="25%">
        ...
        <tr>
            ...
            <td width="25%">
                <asp:DropDownList ID="iccolor" runat="server">
                    <asp:ListItem Value="none">Select Color</asp:ListItem>
         ...
         <tr>
            ...
            <td width="25%" style="height: 26px">
                <asp:DropDownList ID="nationality" runat="server">
                    <asp:ListItem Value="none">Select Nationality</asp:ListItem>
         ...
         <tr>
            ...
            <td width="25%">
                <asp:DropDownList ID="religion" runat="server">
                    <asp:ListItem Value="none">Select Religion</asp:ListItem>
        ...
        <tr>
            ...
            <td width="25%">
                <asp:DropDownList ID="relationship" runat="server">
                    <asp:ListItem Value="none">Select Relationship</asp:ListItem>
