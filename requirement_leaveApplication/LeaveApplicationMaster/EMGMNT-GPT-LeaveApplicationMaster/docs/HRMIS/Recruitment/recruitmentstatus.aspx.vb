...
Partial Public Class recruitmentstatus
    ...
    Private Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim lnkcancel As LinkButton = TryCast(e.Row.FindControl("lnkcancel"), LinkButton)
            If status = "A" Or status = "H" Or status = "R" Or status = "C" Then
    ...
    Public Sub sendno(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Server.Transfer("man_recruitmentrequistion.aspx")
    End Sub
    Public Sub statuscancel(ByVal sender As Object, ByVal e As CommandEventArgs)
        Dim no = e.CommandArgument
        sqltext = "update man_request set status='C' where RequisitionNo='" & no & "'"
    ...
    Protected Sub SqlDataSource1_Selecting(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceSelectingEventArgs) Handles SqlDataSource1.Selecting
        'Session("empcode") = "005000"             'for implement purpose hot code removal
