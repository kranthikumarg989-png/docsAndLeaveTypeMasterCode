        ...
        <tr>
            ...
            <td bgcolor="#ffffff" style="width: 725px" valign="top">
                ...
                <asp:Label ID="lblmsg" runat="server"></asp:Label><br />
                 <asp:Panel ID="Panel1" runat="server" GroupingText="JOB APPLICATION DETAIL" Width="1100px">
                <table style="width: 470px">
                <tr>
                            <td style="height: 59px">
                                KEY IN IC NUMBER AS PER JOB APPLICATION</td>
                ...
                <asp:Panel ID="Pnlempdetails" runat="server" GroupingText="EMPLOYEE NAME & CODE" Width="1100px">
                ...
                <asp:Panel ID="pnloff" runat="server" GroupingText="OFFICIAL DETAILS" Width="1100px">
                        ...
                        <tr>
                            ...
                            <td style="width: 100px">
                                <asp:DropDownList ID="Debank" runat="server" Font-Size="X-small" Width="160px">
                                    ...
                                    <asp:ListItem Value="CIMB" Selected="True">CIMB BANK</asp:ListItem>
                ...
                <asp:Panel ID="pnlpersonal" runat="server" GroupingText="PERSONAL DETAILS" Width="1100px">
                ...
                <asp:Panel ID="pnlunifom" runat="server" GroupingText="Uniform Size Details" Width="1100px">
                ...
                <asp:Panel ID="pnledudet" runat="server" GroupingText="EDUCATION & WORK EXPERIENCE DETAILS" Width="1100px">
                ...
                <asp:Panel ID="pnlaccess" runat="server" GroupingText="ACCESS" Width="1100px">
                    <table style="width: 838px">
                        <tr>
                        ...
                        <tr>
                            ...
                            <table align=left>
                            <tr>
                        <td style="height: 59px; background-color: beige;">
                            <asp:Label ID="Label1" runat="server" Text="Are You Transferring the Employee?" Width="250px"></asp:Label></td>
                        <td style="width: 158px; height: 59px">
                            <asp:RadioButton ID="RbtnTEmpYes" runat="server" GroupName="NewEmp"
                                Text="Yes" AutoPostBack="True" /></td>
                                <td style="width: 158px; height: 59px">
                                    <asp:RadioButton ID="RbtnTEmpNo" runat="server" GroupName="NewEmp"
                                    Text="No" AutoPostBack="True" Checked="True" /></td>
                        <td style="width: 158px; height: 59px; background-color: beige;">
                            <asp:Label ID="LblOldCompany" runat="server" Text="Old Company Name" Visible="False"
                                Width="150px"></asp:Label></td>
                        <td style="width: 158px; height: 59px">
                            <asp:DropDownList ID="CmbOldCompany" runat="server" Visible="False" Width="155px">
                        ...
                        <td style="width: 158px; height: 59px; background-color: beige;">
                            <asp:Label ID="LblOldEmpCode" runat="server" Text="Old Employee Code" Visible="False" Width="150px"></asp:Label></td>
                        <td style="width: 158px; height: 59px">
                            <asp:TextBox ID="TxtOldEmpCode" runat="server" AutoPostBack="true" Visible="False"></asp:TextBox></td>
                    </tr>
                                <tr>
                                    <td style="height: 59px; background-color: beige">
                                        <asp:Label ID="Label2" runat="server" Text="Emergency Contact Person" Width="250px"></asp:Label></td>
                                    <td style="width: 158px; height: 59px">
                                    </td>
                                    <td style="width: 158px; height: 59px">
                                    </td>
                                    <td style="width: 158px; height: 59px; background-color: beige">
                                        <asp:Label ID="Label3" runat="server" Text="Emergency Contact Address" Width="250px"></asp:Label></td>
                                    <td style="width: 158px; height: 59px">
                                    </td>
                                    <td style="width: 158px; height: 59px; background-color: beige">
                                        <asp:Label ID="Label4" runat="server" Text="Emergency Contact Number" Width="250px"></asp:Label></td>
                                    <td style="width: 158px; height: 59px">
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 59px; background-color: beige">
                                        <asp:TextBox ID="TxtContactPerson" runat="server" Width="250px"></asp:TextBox></td>
                                    <td style="width: 158px; height: 59px">
                                    </td>
                                    <td style="width: 158px; height: 59px">
                                    </td>
                                    <td style="width: 158px; height: 59px; background-color: beige">
                                        <asp:TextBox ID="TxtContactAddress" runat="server" TextMode="MultiLine"
                                            Width="250px"></asp:TextBox></td>
                                    <td style="width: 158px; height: 59px">
                                    </td>
                                    <td style="width: 158px; height: 59px; background-color: beige">
                                        <asp:TextBox ID="TxtContactNo" runat="server" Width="250px"></asp:TextBox></td>
                                    <td style="width: 158px; height: 59px">
                                    </td>
                                </tr>
                            </table>
                        ...
                        <tr>
                            <td align="right" colspan="5">
                                <asp:Button ID="Button2" runat="server" SkinID="buttonskin1" Text="Reset" CausesValidation="False" />
                                <asp:Button ID="Button1" runat="server" SkinID="buttonskin1" Text="Print" CausesValidation="False" />
