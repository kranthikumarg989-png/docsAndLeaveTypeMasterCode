...
Partial Public Class Bdayreportsbyselection
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'If comp = "MM" Then
        LogonInfo.ConnectionInfo.ServerName = sver '<- ignores changes to this!!
        LogonInfo.ConnectionInfo.DatabaseName = "hrmis" '<- ignores changes to this!!
        ...
        '    LogonInfo.ConnectionInfo.ServerName = sver '<- ignores changes to this!!
        '    LogonInfo.ConnectionInfo.DatabaseName = "hrmisnew" '<- ignores changes to this!!
        '    LogonInfo.ConnectionInfo.UserID = uid '<- accepts changes to this!!
        '    LogonInfo.ConnectionInfo.Password = pw '<- accepts changes to this!!
        'ElseIf comp = "MO" Then
        '    LogonInfo.ConnectionInfo.ServerName = sver '<- ignores changes to this!!
        '    LogonInfo.ConnectionInfo.DatabaseName = "outsource" '<- ignores changes to this!!
        '    LogonInfo.ConnectionInfo.UserID = uid '<- accepts changes to this!!
        '    LogonInfo.ConnectionInfo.Password = pw '<- accepts changes to this!!
        'End If
