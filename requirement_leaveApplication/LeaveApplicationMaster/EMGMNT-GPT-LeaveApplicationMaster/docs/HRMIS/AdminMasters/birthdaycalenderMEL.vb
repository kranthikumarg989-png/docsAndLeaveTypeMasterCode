...
Public Class birthdaycalenderMEL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "birthdaycalenderMEL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedbirthdaycalenderMEL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As birthdaycalenderMEL = New birthdaycalenderMEL
        rpt.Site = Me.Site
        Return rpt
    End Function
