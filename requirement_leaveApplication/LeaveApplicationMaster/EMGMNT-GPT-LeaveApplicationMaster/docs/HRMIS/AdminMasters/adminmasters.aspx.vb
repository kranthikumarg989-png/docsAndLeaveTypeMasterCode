...
Partial Public Class adminmasters
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            If Session("pnl") = "pnldept" Then
                pnldepartment.Visible = True
                Pnlsection.Visible = False
                Pnldeptrpt.Visible = False
                Pnlsectrpt.Visible = False
                Pnlbirthday.Visible = False
                pnldesignation.Visible = False
                Pnldesigrpt.Visible = False
                Pnlempmaster.Visible = False
                pnlemprpt.Visible = False
            ElseIf Session("pnl") = "pnlsect" Then
                ...
                Pnlempmaster.Visible = False
                pnlemprpt.Visible = False
            ElseIf Session("pnl") = "pnldesig" Then
                pnldepartment.Visible = False
                Pnlsection.Visible = False
                Pnldeptrpt.Visible = False
                Pnlsectrpt.Visible = False
                ...
                Pnlempmaster.Visible = False
                pnlemprpt.Visible = False
            ElseIf Session("pnl") = "pnlemp" Then
                pnldepartment.Visible = False
                Pnlsection.Visible = False
                Pnldeptrpt.Visible = False
                Pnlsectrpt.Visible = False
                ...
                pnldesignation.Visible = False
                Pnldesigrpt.Visible = False
                Pnlempmaster.Visible = True
                pnlemprpt.Visible = False
            ElseIf Session("pnl") = "pnldeptrpt" Then
                pnldepartment.Visible = False
                Pnlsection.Visible = False
                Pnldeptrpt.Visible = True
                Pnlsectrpt.Visible = False
                Pnlbirthday.Visible = False
                pnldesignation.Visible = False
                Pnldesigrpt.Visible = False
                Pnlempmaster.Visible = False
                pnlemprpt.Visible = False
            ElseIf Session("pnl") = "pnlsectrpt" Then
                pnldepartment.Visible = False
                Pnlsection.Visible = False
                Pnldeptrpt.Visible = False
                Pnlsectrpt.Visible = True
                Pnlbirthday.Visible = False
                pnldesignation.Visible = False
                Pnldesigrpt.Visible = False
                Pnlempmaster.Visible = False
                pnlemprpt.Visible = False
            ElseIf Session("pnl") = "pnldesirpt" Then
                pnldepartment.Visible = False
                Pnlsection.Visible = False
                Pnldeptrpt.Visible = False
                Pnlsectrpt.Visible = False
                Pnlbirthday.Visible = False
                pnldesignation.Visible = False
                Pnldesigrpt.Visible = True
                Pnlempmaster.Visible = False
                pnlemprpt.Visible = False
            ElseIf Session("pnl") = "pnlemprpt" Then
                pnldepartment.Visible = False
                Pnlsection.Visible = False
                Pnldeptrpt.Visible = False
                Pnlsectrpt.Visible = False
                ...
                Pnldesigrpt.Visible = False
                Pnlempmaster.Visible = False
                pnlemprpt.Visible = True
            ElseIf Session("pnl") = "pnlbday" Then
                pnldepartment.Visible = False
                Pnlsection.Visible = False
                Pnldeptrpt.Visible = False
                Pnlsectrpt.Visible = False
    ...
    Protected Sub Bdept_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Bdept_save.Click
        ...
        InsertDepartment(Tdeptcode.Text, TDeptname.Text, dJhead.SelectedValue, Convert.ToString(Ddirect.SelectedItem), Convert.ToString(dsection.SelectedItem), tdabbrevation.Text, pid, did, _eid)
        If recstatus = True Then
            MessageBox("Record Saved successfully")
            ' pdept.Visible = True
            Tdeptcode.Text = ""
        ...
        If recstatus = True Then
            ...
            If dsdata.Tables(0).Rows.Count > 0 Then
                ...
                If Len(Trim(dr("nationality") & "")) <> 0 Then
                    denation.SelectedValue = dr("nationality").ToString
                End If
                ...
                End If
                dElevel.SelectedValue = dr("edulevel").ToString
