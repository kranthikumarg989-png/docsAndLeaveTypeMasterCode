<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="PRReports.aspx.vb" Inherits="E_Management.PRReports" 
    title="Production REquest Report" %>
                            ...
                            <table>
                                <tr>
                                    <td class="td_head" colspan="2" style="height: 24px">
                                        Production Request &nbsp;Report Overall</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 403px; height: 26px">
                                        ...
                                        <span style="font-size: 10pt; color: #660000">(Please choose between 01st and 28th/29th/30th/31st
                                            based on month)</span></td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 403px; height: 26px">
                                        <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                            DataTextField="trans_groupcode" DataValueField="trans_groupcode">
                                            <asp:ListItem Selected="True" Value="-1">--Select--</asp:ListItem>
                                        </asp:DropDownList>&nbsp;
                                        <asp:CheckBox ID="CheckBox1" runat="server" Text="All" /></td>
                                </tr>
                                <tr>
