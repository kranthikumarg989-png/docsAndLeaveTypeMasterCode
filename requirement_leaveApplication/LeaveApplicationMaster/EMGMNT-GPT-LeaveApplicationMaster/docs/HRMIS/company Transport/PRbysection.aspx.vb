...
Partial Public Class PRbysection
    ...
    Public Sub InsertPR()
        ...
        '02.01.2012 commented following code >> payroll month 21 to 20
        ...
        '    Exit Sub
        'End If
        '02.01.2012 following code for payroll month 01 to 31
        ...
        If dsPR1.Tables(0).Rows.Count <> 0 Then
            ...
            If keyindt >= cutoff Then
                If Session("empcode") <> "014623" Or Session("empcode") <> "017433" Or Session("empcode") <> "017479" Or Session("empcode") <> "017970" Then
                    GridView1.Visible = False
    ...
    Function chkPRRecExist(ByVal sect As String, ByVal vfd As Date, ByVal vtd As Date, ByVal grp As String, ByVal cate As String) As DataSet
        ...
        ' commenting below line to support 01 to 31st month where todate always not the same.
        'Command = New SqlCommand("select * from trans_productionrequest where fromdate= '" & vfd & "' and todate='" & vtd & "' and sectioncode='" & sect & "' and groupcode = '" & grp & "'  and category = '" & cate & "'", con)
        Command = New SqlCommand("select * from trans_productionrequest where fromdate= '" & vfd & "' and sectioncode='" & sect & "' and groupcode = '" & grp & "'  and category = '" & cate & "'", con) 'and todate='" & vtd & "' 
    ...
    Function chkPRRecExist1(ByVal sect As String, ByVal vfd As Date, ByVal vtd As Date, ByVal cate As String) As DataSet
        ...
        con.Open()
        Dim Command As New SqlCommand
        ' changing this to suit for 01 to 31st month style as todate differs every month.
        ...
        Command = New SqlCommand("select * from trans_productionrequest where fromdate= '" & vfd & "' and sectioncode='" & sect & "' and category = '" & cate & "'", con) 'and todate='" & vtd & "'
        Command.CommandType = CommandType.Text
        Dim DataAdap = New SqlDataAdapter(Command)
        DataAdap.Fill(ds, "Pr")
        con.Close()
                ...
                If dsPRs.Tables(0).Rows.Count <> 0 Then
                    ...
                    Try
                        ...
                        If DS.Tables(0).Rows.Count <> 0 Then
                            ...
                            If dm = "30" Then
                                str = ("insert into trans_productionrequesttemp(empcode,departmentcode,sectioncode,fromdate,todate,groupcode,day21,day22,day23,day24,day25,day26,day27,day28,day29,day30,day31,day1,day2,day3,day4,day5,day6,day7,day8,day9,day10,day11,day12,day13,day14,day15,day16,day17,day18,day19,day20) values ('" & emp & "','" & dept & "','" & sect & "','" & fd & "','" & td & "','" & mygrp & "','" & myday(20) & "','" & myday(21) & "','" & myday(22) & "','" & myday(23) & "','" & myday(24) & "','" & myday(25) & "','" & myday(26) & "','" & myday(27) & "','" & myday(28) & "','" & myday(29) & "','" & a & "','" & myday(0) & "','" & myday(1) & "','" & myday(2) & "','" & myday(3) & "','" & myday(4) & "','" & myday(5) & "','" & myday(6) & "','" & myday(7) & "','" & myday(8) & "','" & myday(9) & "','" & myday(10) & "','" & myday(11) & "','" & myday(12) & "','" & myday(13) & "','" & myday(14) & "','" & myday(15) & "','" & myday(16) & "','" & myday(17) & "','" & myday(18) & "','" & myday(19) & "')")
                                Cmd = New SqlCommand(str, con)
                                Cmd.ExecuteNonQuery()

                            ElseIf dm = "31" Then
                                str = ("insert into trans_productionrequesttemp(empcode,departmentcode,sectioncode,fromdate,todate,groupcode,day21,day22,day23,day24,day25,day26,day27,day28,day29,day30,day31,day1,day2,day3,day4,day5,day6,day7,day8,day9,day10,day11,day12,day13,day14,day15,day16,day17,day18,day19,day20) values ('" & emp & "','" & dept & "','" & sect & "','" & fd & "','" & td & "','" & mygrp & "','" & myday(20) & "','" & myday(21) & "','" & myday(22) & "','" & myday(23) & "','" & myday(24) & "','" & myday(25) & "','" & myday(26) & "','" & myday(27) & "','" & myday(28) & "','" & myday(29) & "','" & myday(30) & "','" & myday(0) & "','" & myday(1) & "','" & myday(2) & "','" & myday(3) & "','" & myday(4) & "','" & myday(5) & "','" & myday(6) & "','" & myday(7) & "','" & myday(8) & "','" & myday(9) & "','" & myday(10) & "','" & myday(11) & "','" & myday(12) & "','" & myday(13) & "','" & myday(14) & "','" & myday(15) & "','" & myday(16) & "','" & myday(17) & "','" & myday(18) & "','" & myday(19) & "')")
                                Cmd = New SqlCommand(str, con)
                                Cmd.ExecuteNonQuery()

                            ElseIf dm = "28" Then
                                str = ("insert into trans_productionrequesttemp(empcode,departmentcode,sectioncode,fromdate,todate,groupcode,day21,day22,day23,day24,day25,day26,day27,day28,day29,day30,day31,day1,day2,day3,day4,day5,day6,day7,day8,day9,day10,day11,day12,day13,day14,day15,day16,day17,day18,day19,day20) values ('" & emp & "','" & dept & "','" & sect & "','" & fd & "','" & td & "','" & mygrp & "','" & myday(20) & "','" & myday(21) & "','" & myday(22) & "','" & myday(23) & "','" & myday(24) & "','" & myday(25) & "','" & myday(26) & "','" & myday(27) & "','" & a & "','" & a & "','" & a & "','" & myday(0) & "','" & myday(1) & "','" & myday(2) & "','" & myday(3) & "','" & myday(4) & "','" & myday(5) & "','" & myday(6) & "','" & myday(7) & "','" & myday(8) & "','" & myday(9) & "','" & myday(10) & "','" & myday(11) & "','" & myday(12) & "','" & myday(13) & "','" & myday(14) & "','" & myday(15) & "','" & myday(16) & "','" & myday(17) & "','" & myday(18) & "','" & myday(19) & "')")
                                Cmd = New SqlCommand(str, con)
                                Cmd.ExecuteNonQuery()

                            ElseIf dm = "29" Then
                                str = ("insert into trans_productionrequesttemp(empcode,departmentcode,sectioncode,fromdate,todate,groupcode,day21,day22,day23,day24,day25,day26,day27,day28,day29,day30,day31,day1,day2,day3,day4,day5,day6,day7,day8,day9,day10,day11,day12,day13,day14,day15,day16,day17,day18,day19,day20) values ('" & emp & "','" & dept & "','" & sect & "','" & fd & "','" & td & "','" & mygrp & "','" & myday(20) & "','" & myday(21) & "','" & myday(22) & "','" & myday(23) & "','" & myday(24) & "','" & myday(25) & "','" & myday(26) & "','" & myday(27) & "','" & myday(28) & "','" & a & "','" & a & "','" & myday(0) & "','" & myday(1) & "','" & myday(2) & "','" & myday(3) & "','" & myday(4) & "','" & myday(5) & "','" & myday(6) & "','" & myday(7) & "','" & myday(8) & "','" & myday(9) & "','" & myday(10) & "','" & myday(11) & "','" & myday(12) & "','" & myday(13) & "','" & myday(14) & "','" & myday(15) & "','" & myday(16) & "','" & myday(17) & "','" & myday(18) & "','" & myday(19) & "')")
                                Cmd = New SqlCommand(str, con)
                                Cmd.ExecuteNonQuery()
                            End If
