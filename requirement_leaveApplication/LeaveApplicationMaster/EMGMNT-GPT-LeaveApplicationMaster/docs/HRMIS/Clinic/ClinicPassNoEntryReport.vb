...
Public Class ClinicPassNoEntryReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ClinicPassNoEntryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Option1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedClinicPassNoEntryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ClinicPassNoEntryReport = New ClinicPassNoEntryReport
        rpt.Site = Me.Site
        Return rpt
    End Function
