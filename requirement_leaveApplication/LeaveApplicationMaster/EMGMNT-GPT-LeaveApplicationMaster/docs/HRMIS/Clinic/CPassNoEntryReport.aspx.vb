...
Partial Public Class CPassNoEntryReport
    ...
    Dim crReportDocument As ClinicPassNoEntryReport
...
#End Region
    ...
    Private Sub Loadreport1()
        ...
        Str = Server.MapPath("ClinicPassNoEntryReport.rpt")
        Cr.Load(Str)
        TmpDs = New DataSet()
        'Dim Rnumber As Integer
        'Rnumber = 1
        Dim Option1 As String = Session("cl_Option1")
        Dim Date1 As String = Session("cl_date1")
        Dim Date2 As String = Session("cl_date2")

  

        TmpDs = CliniReport(Option1, Date1, Date2)
    ...
    Private Sub CallReport()
        ...
        crReportDocument = New ClinicPassNoEntryReport
    ...
    Public Function CliniReport(ByVal Option1 As String, ByVal Date1 As DateTime, ByVal Date2 As DateTime) As DataSet
        ...
        SqlCmd.CommandText = "NoClinicPassReport"
