...
Partial Public Class MCReport_
    ...
    Protected Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Session("MCdesig") = Trim(ddldesigr.SelectedValue)
        Session("MCemp") = Trim(txtempidr.Text)
        Session("MCsect") = Trim(ddlsectrpt.SelectedValue)
        Session("MCdept") = ddldeptr.SelectedValue.Trim
