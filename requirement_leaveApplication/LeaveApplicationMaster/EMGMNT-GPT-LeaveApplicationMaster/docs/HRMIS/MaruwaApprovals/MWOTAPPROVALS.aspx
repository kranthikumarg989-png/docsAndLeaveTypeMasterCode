<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="MWOTAPPROVALS.aspx.vb" Inherits="E_Management.MWOTAPPROVALS" 
    title="Maruwa Group of Companies -OT Approvals" %>
                            ...
                            <asp:GridView runat="server" ID="EAOTapproval" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Status" SortExpression="Status">
                                        ...
                                        <ItemTemplate>
                                            <asp:RadioButtonList ID="OTapprovalStat" runat="server" SelectedValue='<%# Bind("status") %>' RepeatDirection="Horizontal">
