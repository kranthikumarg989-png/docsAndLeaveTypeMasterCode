...
Partial Public Class MWTCAPPROVALS
    ...
    End Sub
     Protected Sub SearchGridapp(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        Dim str
