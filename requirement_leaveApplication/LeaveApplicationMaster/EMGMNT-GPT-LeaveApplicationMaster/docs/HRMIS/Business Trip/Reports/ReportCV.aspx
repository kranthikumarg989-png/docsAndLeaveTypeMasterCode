<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ReportCV.aspx.vb" Inherits="E_Management.ReportCV" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%">
        <tbody>
            ...
            <tr>
                <td background="../../../images/cen_lef.gif" style="width: 16px; height: 365px">
                    <img height="11" src="../../../images/cen_lef.gif" width="16" /></td>
                <td bgcolor="#ffffff" style="width: 1208px; height: 365px" valign="top">
                    <table>
                        <tbody>
                            <tr>
                                <td colspan="2" style="width: 776px; border-bottom: 2px solid; height: 295px">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="td_head" colspan="2" style="height: 24px">
                                                    Customer Visit Reports Overall</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 403px; height: 17px">
                                                    <asp:RadioButtonList ID="rdoptions" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                                                        Width="408px">
                                                        <asp:ListItem Value="Cust">ByCust</asp:ListItem>
                                                        <asp:ListItem Value="BT">ByBTno</asp:ListItem>
                                            ...
                                            <tr>
                                                <td style="width: 148px; height: 24px; background-color: beige">
                                                    <asp:Label ID="lbldeptr" runat="server" Text="Select Customer"></asp:Label>&nbsp;</td>
                                                <td style="width: 403px; height: 24px">
                                                    <asp:DropDownList ID="ddlcust" runat="server" DataSourceID="SqlDataSource2"
                                            ...
                                            <tr>
                                                <td style="width: 148px; height: 24px; background-color: beige">
                                                    <asp:Label ID="lbldesigr" runat="server" Text="By BTNo"></asp:Label></td>
                                                <td style="width: 403px; height: 24px">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                                        SelectCommand="SELECT DISTINCT [customer] FROM [custmaster]"></asp:SqlDataSource>
                                </td>
                            </tr>
                ...
                <td background="../../../images/cen_rig.gif" style="width: 25px; height: 365px">
                    <img height="11" src="../../../images/cen_rig.gif" width="24" /></td>
            </tr>
            <tr>
                <td style="width: 16px; height: 16px">
                    <img height="16" src="../../../images/bot_lef.gif" width="16" /></td>
                <td background="../../../images/bot_mid.gif" style="width: 1208px; height: 16px">
