<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ReportTC.aspx.vb" Inherits="E_Management.ReportTC" 
    title="TRAVELLING CLAIM REPORTS" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tbody>
            <tr>
                ...
                <td background="../../../images/top_mid.gif" height="16" style="width: 1208px">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="td_head" colspan="2" style="height: 24px">
                                                    Travelling Claim &nbsp;Reports Overall</td>
                                            </tr>
                                            <tr>
