<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="BTEAViewaspx.aspx.vb" Inherits="E_Management.BTEAViewaspx" 
    title="EA Approval" %>
...
<asp:Panel ID="Panel1" runat="server">
 <asp:GridView ID="GridView2" runat="server" BackColor="LightGoldenrodYellow" BorderColor="Tan"
    ...
    <asp:Label ID="lblmsg" runat="server" Font-Size="Medium" Text="Click Recno for Customer/Supplier Details"></asp:Label>&nbsp;<br />
    &nbsp;
    &nbsp;&nbsp;<br />
  ...
  <asp:GridView ID="GridView1" 
        ...
        ForeColor="#333333" GridLines="Vertical" DataKeyNames=recno 
        EmptyDataText="No Records waiting for approval">
        <Columns>
