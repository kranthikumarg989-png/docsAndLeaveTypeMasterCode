<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="TcFMDapproval.aspx.vb" Inherits="E_Management.TcFMDapproval" 
    title="TRAVELLING CLAIM-FMD" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
        ...
        <Columns>
            <asp:BoundField DataField="Rno" HeaderText="TC No" SortExpression="Rno" />
            ...
            <asp:TemplateField HeaderText="Remarks" SortExpression="remarks">
                               <ItemTemplate>
                    <asp:TextBox ID="txtremarks" runat="server" Height="42px" Text='<%# Bind("FMDREMARKS") %>'
            ...
            <asp:TemplateField HeaderText="Status" SortExpression="status">
                <ItemTemplate>
                    <asp:RadioButtonList ID="rbstatus" runat="server" SelectedValue='<%# Bind("STATUS") %>'>
                        <asp:ListItem Value="FAPPROVED">PENDING</asp:ListItem>
                        <asp:ListItem Value="FMDAPPROVED">APPROVE</asp:ListItem>
                        <asp:ListItem Value="FMDREJECTED">REJECT</asp:ListItem>
                    </asp:RadioButtonList>
                </ItemTemplate>
                <FooterTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
        SelectCommand="SELECT acc_businesstrip.recno, HRMIS_TC_Travellingclaimnew.Empcode, HRMIS_TC_Travellingclaimnew.FMDREMARKS, HRMIS_TC_Travellingclaimnew.HODAPPROVED, HRMIS_TC_Travellingclaimnew.happrovedtime, HRMIS_TC_Travellingclaimnew.Rno, HRMIS_TC_Travellingclaimnew.paid, empmaster.empname, empmaster.departmentcode, acc_businesstrip.fromdate, acc_businesstrip.todate, acc_businesstrip.purpose, acc_businesstrip.travellingallowances, HRMIS_TC_Travellingclaimnew.tallowance, LTRIM(RTRIM(HRMIS_TC_Travellingclaimnew.status)) AS STATUS FROM acc_businesstrip INNER JOIN HRMIS_TC_Travellingclaimnew ON acc_businesstrip.recno = HRMIS_TC_Travellingclaimnew.btrno INNER JOIN empmaster ON HRMIS_TC_Travellingclaimnew.Empcode = empmaster.empcode WHERE (HRMIS_TC_Travellingclaimnew.paid = 'NP') AND (HRMIS_TC_Travellingclaimnew.status = 'FAPPROVED' ) ORDER BY RNO DESC">
    </asp:SqlDataSource>
