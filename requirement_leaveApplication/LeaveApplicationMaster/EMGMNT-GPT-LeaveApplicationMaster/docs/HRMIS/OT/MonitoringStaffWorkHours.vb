...
Public Class MonitoringStaffWorkHours
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MonitoringStaffWorkHours.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Deptcode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedMonitoringStaffWorkHours
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonitoringStaffWorkHours = New MonitoringStaffWorkHours
        rpt.Site = Me.Site
        Return rpt
    End Function
