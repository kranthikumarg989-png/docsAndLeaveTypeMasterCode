<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="BudgetSettings.aspx.vb" Inherits="E_Management.BudgetSettings" 
        ...
        <tr>
            <td style="width: 176px; height: 249px;" valign="top" align="center">
                <table id="TABLE1" onclick="return TABLE1_onclick()" style="width: 500px; height: 120px" border="1" cellpadding="1" cellspacing="1">
                    <tr>
                        ...
                        <asp:Label ID="Label1" runat="server" Font-Underline="True" ForeColor="Maroon" Text="BUDGET SETTINGS"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="txtto" runat="server"  Width="180px"></asp:TextBox>
            ...
            <td style="width: 6100px; height: 249px;">
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                    SelectCommand="SELECT tbl_MaxOTSetting.id, tbl_MaxOTSetting.startdate, tbl_MaxOTSetting.enddate, tbl_MaxOTSetting.Category, tbl_MaxOTSetting.sect, tbl_MaxOTSetting.MaxHours, tbl_MaxOTSetting.status FROM tbl_MaxOTSetting INNER JOIN sectionmaster ON tbl_MaxOTSetting.sect = sectionmaster.sectioncode INNER JOIN department ON sectionmaster.departmentcode = department.departmentcode WHERE (tbl_MaxOTSetting.status = 'S') ORDER BY tbl_MaxOTSetting.id desc">
                </asp:SqlDataSource>
