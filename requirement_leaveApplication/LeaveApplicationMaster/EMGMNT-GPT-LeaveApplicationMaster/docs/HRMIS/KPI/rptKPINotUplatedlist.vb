...
Public Class rptKPINotUplatedlist
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptKPINotUplatedlist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKPINotUplatedlist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKPINotUplatedlist = New rptKPINotUplatedlist
        rpt.Site = Me.Site
        Return rpt
    End Function
