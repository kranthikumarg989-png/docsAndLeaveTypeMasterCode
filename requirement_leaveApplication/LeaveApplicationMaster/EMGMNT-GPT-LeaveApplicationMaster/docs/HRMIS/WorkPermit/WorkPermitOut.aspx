<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WorkPermitOut.aspx.vb" Inherits="E_Management.WorkPermitOut"   MasterPageFile="~/ems.Master" title=" " %>
        ...
        <tr>
          ...
          <tr>
              <td align="center">
                  <table cellpadding="3" cellspacing="0">
                      <tr>
                          <td>Status</td><td>:</td><td><asp:DropDownList ID="ddlStatus" runat="server" CssClass= "form-control" ></asp:DropDownList></td>
                      </tr>
                      <tr>
                          <td>Received By</td><td>:</td><td> <asp:DropDownList ID="ddlEmpCode" runat="server" CssClass= "form-control" ></asp:DropDownList></td>
                      </tr>
                      <tr>
                          <td>Issued On</td><td>:</td><td><asp:TextBox ID="txtReceivedDate" runat="server"  CssClass= "form-control"  ></asp:TextBox>     </td>
                      </tr>
                      <tr>
                          <td>Remarks</td><td>:</td><td><asp:TextBox ID="txtRemarks" runat="server"  CssClass= "form-control" TextMode="MultiLine"  ></asp:TextBox>     </td>
                      </tr>
                      <tr>
                          <td align="center">
    ...
    <script type="text/javascript">
        ...
        $("#<%= btnSubmit.ClientID %>").click(function() {  
         ...
         if (($("#<%=ddlEmpCode.ClientID %>").val()=="Select")) {
             alert("Please specify the Received By");
