...
Partial Public Class leave_designation
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim desig As String = Session("alldesig")
        ...
        Try
            ...
            paramField.ParameterFieldName = "designation"
            discreteVal.Value = desig
            ...
            rval.StartValue = fromd
            rval.EndValue = tod
            paramField.CurrentValues.Add(rval)
            paramFields.Add(paramField)
