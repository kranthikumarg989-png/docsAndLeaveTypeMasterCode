...
Public Class OverallLeavesummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OverallLeavesummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOverallLeavesummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OverallLeavesummary = New OverallLeavesummary
        rpt.Site = Me.Site
        Return rpt
    End Function
