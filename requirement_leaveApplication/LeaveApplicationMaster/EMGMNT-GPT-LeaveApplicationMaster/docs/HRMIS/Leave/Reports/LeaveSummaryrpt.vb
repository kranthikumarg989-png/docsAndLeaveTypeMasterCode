...
Public Class LeaveSummaryrpt
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_leavetype() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedLeaveSummaryrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LeaveSummaryrpt = New LeaveSummaryrpt
        rpt.Site = Me.Site
        Return rpt
    End Function
