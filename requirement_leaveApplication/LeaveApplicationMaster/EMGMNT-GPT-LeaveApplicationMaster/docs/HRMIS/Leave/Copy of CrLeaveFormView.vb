...
Public Class Copy_of_CrLeaveFormView
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy of CrLeaveFormView.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_CrLeaveFormView
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_CrLeaveFormView = New Copy_of_CrLeaveFormView
        rpt.Site = Me.Site
        Return rpt
    End Function
