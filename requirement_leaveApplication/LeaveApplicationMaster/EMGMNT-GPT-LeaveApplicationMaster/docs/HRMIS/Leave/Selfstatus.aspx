                    ...
                    <tr>
                        <td style="vertical-align: middle">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Status" SortExpression="status">
                                     ...
                                     <asp:TemplateField HeaderText="Print">
                                        <ItemTemplate>
                                         <asp:LinkButton ID="LinkButton9" runat="server" CausesValidation="false" CommandArgument='<%# Eval("appno", "{0}") %>'
                                                ForeColor="Maroon" OnCommand="leaveprint" Text="Print"></asp:LinkButton>
                            ...
                            <asp:SqlDataSource ID="Sqlleave" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                                SelectCommand="SELECT * FROM [Leaveform] WHERE (([fromdate] >= @from)) AND ([empno] = @empcode)  order by appno desc">
                                <SelectParameters>
