...
Partial Public Class frmRptIssueDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        crystalReport.Load(Server.MapPath("rptIssueDetails.rpt"))
        ...
        crystalReport.SetParameterValue("@Category", Request.QueryString("Cat"))
        crystalReport.SetParameterValue("@Group", Request.QueryString("Grp"))
        crystalReport.SetParameterValue("@Item", Request.QueryString("Itm"))
