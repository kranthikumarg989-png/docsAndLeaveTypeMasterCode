...
Public Class rptPPEbyDeptSection
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPPEbyDeptSection.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPPEbyDeptSection
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPPEbyDeptSection = New rptPPEbyDeptSection
        rpt.Site = Me.Site
        Return rpt
    End Function
