...
Partial Public Class frmReceivedPayment
    ...
    Protected Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ClientScript.RegisterStartupScript(GetType(String), "IssueReceivePrint", "IssueReceiveRpt('" + ddlDept.SelectedValue + "','" + txtFromDt.Text.Trim() + "','" + txtToDt.Text.Trim() + "')", True)
    End Sub
End Class