<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ReceivedSummary.aspx.vb" Inherits="E_Management.ReceivedSummary1" %>
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 100%">
                                <tr>
                                    <td style="border-left-color: #33ffff; border-bottom-color: #33ffff; border-top-color: #33ffff;
                                        ...
                                        <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="White" Text="Received Summary"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td >
                                    </td>
