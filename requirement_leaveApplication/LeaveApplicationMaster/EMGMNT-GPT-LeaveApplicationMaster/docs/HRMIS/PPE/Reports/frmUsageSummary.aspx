<%@ Page Language="vb" AutoEventWireup="false" Codebehind="frmUsageSummary.aspx.vb"
    MasterPageFile="~/ems.Master" Inherits="E_Management.frmUsageSummary" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">

    <script language="javascript" type="text/javascript">
  function UsageRpt(Tpe,Dpt,Fdt,Tdt)
           {
//           alert("wel");
//           alert(Issueno);
            PrintUsageRpt= window.open('frmRptUsageSummary.aspx?Type='+Tpe+"&Dept="+ Dpt+"&FDt="+ Fdt+"&TDt="+ Tdt,'UsageRpt','height=600,width=990,scrollbars=yes,resizable=yes');
            if(window.focus)
             {
             PrintUsageRpt.focus();              
             }    
    ...
    <table cellpadding="0" cellspacing="0" align="center">
        ...
        <tr>
            ...
            <td bgcolor="#ffffff" valign="top" style="height: 100px">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:Label ID="Label8" runat="server" ForeColor="DarkRed" Font-Bold="True" Font-Size="12pt"
                                            Text="Usage Summary" Font-Underline="False"></asp:Label></td>
                                </tr>
                                <tr height="5">
                                </tr>
                                <tr>
                ...
                </table><asp:Button ID="Button1" runat="server" Text="Usage Cost by Department" ValidationGroup ="val" /></td>
