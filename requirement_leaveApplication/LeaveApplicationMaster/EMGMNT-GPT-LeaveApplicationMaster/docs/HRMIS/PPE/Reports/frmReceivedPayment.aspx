<%@ Page Language="vb" AutoEventWireup="false" Codebehind="frmReceivedPayment.aspx.vb"
    MasterPageFile="~/ems.Master" Inherits="E_Management.frmReceivedPayment" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">

    <script language="javascript" type="text/javascript">
  function IssueReceiveRpt(Dpt,Fdt,Tdt)
           {
            PrintReceiveRpt= window.open('frmRPTReceivedPayment.aspx?Dept='+ Dpt+"&FDt="+ Fdt+"&TDt="+ Tdt,'ReceiveRpt','height=600,width=990,scrollbars=yes,resizable=yes');
            if(window.focus)
             {
             PrintReceiveRpt.focus();              
             }    
              return false;
           }   
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:Label ID="Label8" runat="server" ForeColor="DarkRed" Font-Bold="True" Font-Size="12pt"
                                            Text="Received Payments" Font-Underline="False"></asp:Label></td>
                                </tr>
                                <tr height="5">
                                </tr>
                                <tr>
