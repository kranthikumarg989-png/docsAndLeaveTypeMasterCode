<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="PRbysection.aspx.vb" Inherits="E_Management.PRbysection" 
    title="Production Request Master" %>
                ...
                <table>
                    ...
                    <tr>
                         <td class="td_head" colspan="4" style="height: 21px">
                             Key in Production Request from 21st to 20th</td>                               
                       </tr>
                    <tr>
                         <td style="width: 120px; background-color: beige; height: 37px;">
                             FromDate</td>
                        <td style="width: 153px; background-color: beige; height: 37px;">
                        ...
                        <td style="width: 73px; background-color: beige; height: 37px;">
                            Todate</td>
                        <td style="width: 196px; background-color: beige; height: 37px;">
                    ...
                    <tr>
                         <td style="width: 120px; background-color: beige; height: 24px;">
                             Section</td>
                        <td  style="background-color: beige; width: 153px;">
                            <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource3"
                                DataTextField="sect" DataValueField="sectioncode" Width="212px" AppendDataBoundItems="True" AutoPostBack="True">
                                <asp:ListItem Selected="True" Value="-1">--Select--</asp:ListItem>
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DropDownList2"
                                InitialValue="-1">*</asp:RequiredFieldValidator>
                        </td>
                       <td style="width: 73px; background-color: beige; height: 24px;">
                            Set by</td>
                        <td  style="background-color: beige; height: 24px;">
                            ...
                            ControlToValidate="DropDownList3" InitialValue="-1">*</asp:RequiredFieldValidator></td>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="2" style="background-color: beige">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None" ShowFooter="True" Visible="False">
                    ...
                    <asp:DropDownList ID="Ddl29" runat="server" DataSourceID="SqlData9"
                       ...
                       <asp:DropDownList ID="Ddl30" runat="server" DataSourceID="SqlData10"
                                    DataTextField="trans_shiftcode" DataValueField="trans_shiftcode" AppendDataBoundItems=true   SelectedValue='<%# Bind("day30") %>'>
                                <asp:ListItem Selected="True" Value="NA">NA</asp:ListItem>
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="SqlData10" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %> "
                                    SelectCommand="SELECT DISTINCT [trans_shiftcode] FROM [trans_shifttime] ORDER BY [trans_shiftcode]">
                                </asp:SqlDataSource>  
                        ...
                        <asp:TemplateField HeaderText="31" SortExpression="day31">
                         ...
                         <asp:DropDownList ID="Ddl31" runat="server" DataSourceID="SqlData11"
                                    DataTextField="trans_shiftcode" DataValueField="trans_shiftcode"  AppendDataBoundItems=true  SelectedValue='<%# Bind("day31") %>'>
                                 <asp:ListItem Selected="True" Value="NA">NA</asp:ListItem>
                                </asp:DropDownList>
                      ...
                      <asp:DropDownList ID="Ddl11" runat="server" DataSourceID="SqlData22"
                       ...
                       <asp:DropDownList ID="Ddl13" runat="server" DataSourceID="SqlData24"
                        ...
                        <asp:TemplateField HeaderText="17" SortExpression="day17">
                            ...
                            <ItemTemplate>
                        <asp:DropDownList ID="Ddl17" runat="server" DataSourceID="SqlData28" AppendDataBoundItems=true 
                                    DataTextField="trans_shiftcode" DataValueField="trans_shiftcode"  SelectedValue='<%# Bind("day17") %>'>
                                      <asp:ListItem Text="Please select" Value=""></asp:ListItem>
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="SqlData28" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                                    SelectCommand="SELECT DISTINCT [trans_shiftcode] FROM [trans_shifttime] ORDER BY [trans_shiftcode]">
                                </asp:SqlDataSource> 
                                     </ItemTemplate>
                        </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="day21" HeaderText="21" SortExpression="day21" />
                        ...
                        <asp:BoundField DataField="day25" HeaderText="d25" SortExpression="day25" />
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="grdsection" runat="server" AutoGenerateColumns="False" BackColor="White"
                                BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource5"
                        ...
                        <asp:TemplateField HeaderText="changeGroup" SortExpression="groupcode">
                            ...
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlgridgrp" runat="server" DataSourceID="sqlgridgroup"
                                 DataTextField="trans_groupcode" DataValueField="trans_groupcode" AppendDataBoundItems=true
                                 OnSelectedIndexChanged="Getshiftbygroup1" AutoPostBack="True" SelectedValue='<%# Bind("groupcode") %>'>
                                    <asp:ListItem Selected="True" Value="-1" >-Select-</asp:ListItem>
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="sqlgridgroup" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                                    SelectCommand="SELECT DISTINCT [trans_groupcode] FROM [trans_groupmaster] ORDER BY [trans_groupcode]">
                                    ...
                                    <asp:TemplateField HeaderText="18" SortExpression="day18">
                                        ...
                                        <ItemTemplate>
                                            <asp:DropDownList ID="Ddl18" runat="server" DataSourceID="SqlData29" DataTextField="trans_shiftcode"
                                                DataValueField="trans_shiftcode" SelectedValue='<%# Bind("day18") %>' AppendDataBoundItems=true >
                                                  <asp:ListItem Text="Please select" Value=""></asp:ListItem>
                                            </asp:DropDownList>
                                            
                                            <asp:SqlDataSource ID="SqlData29" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                                                SelectCommand="SELECT DISTINCT [trans_shiftcode] FROM [trans_shifttime] ORDER BY [trans_shiftcode]">
                                            </asp:SqlDataSource>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="19" SortExpression="day19">
                                        ...
                                        <ItemTemplate>
                                            <asp:DropDownList ID="Ddl19" runat="server" DataSourceID="SqlData30" DataTextField="trans_shiftcode"
                                                DataValueField="trans_shiftcode" SelectedValue='<%# Bind("day19") %>' AppendDataBoundItems="true">
                                                  <asp:ListItem Text="Please select" Value=""></asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:SqlDataSource ID="SqlData30" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                                                SelectCommand="SELECT DISTINCT [trans_shiftcode] FROM [trans_shifttime] ORDER BY [trans_shiftcode]">
                                            </asp:SqlDataSource>
                                        </ItemTemplate>
                                    </asp:TemplateField>
