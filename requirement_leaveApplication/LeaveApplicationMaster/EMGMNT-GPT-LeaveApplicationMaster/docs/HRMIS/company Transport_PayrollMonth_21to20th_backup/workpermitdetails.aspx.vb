...
Partial Public Class Workpermitdetails
    ...
    Protected Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            InsertWPDetails(TextBox1.Text.Trim, Label2.Text.Trim, md, cd, txtyrs.Text.Trim, txtrefno.Text.Trim, fd, txtpoi.Text.Trim, txtbgno.Text.Trim, td, txtbgamt.Text.Trim, insdt, txtino.Text.Trim, txtpermit.Text.Trim, txtvtype.Text.Trim, txtreceipt.Text.Trim, txtpass.Text.Trim, txtlevy.Text.Trim, txtvisa.Text.Trim, txtprocess.Text.Trim, _eid)
