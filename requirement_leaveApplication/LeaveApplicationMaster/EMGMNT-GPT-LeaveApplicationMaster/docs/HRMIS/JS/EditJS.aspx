<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="EditJS.aspx.vb" Inherits="E_Management.EditJS" %>
...
<table cellpadding=0 cellspacing=0>
                    <tr>
                        ...
                        <td background="../../images/top_mid.gif" style="height: 16px; width: 668px;">
                    ...
                    <tr>
                        ...
                        <td vAlign="top" bgColor="#ffffff" style="width: 668px">
                            <table>
                                <tr>
                                ...
                                <tr>
                                    <td style="height: 17px; background-color: beige; width: 80px;">
                                        EmpCode</td>
                                    <td style="width: 219px; background-color: beige;">
                                        <asp:Label ID="lblempcode" runat="server"></asp:Label></td>
                                    <td style="background-color: beige; width: 83px;">
                                        EmpName</td>
                                    <td style="background-color: beige; width: 500px;">
                                        <asp:Label ID="lblename" runat="server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="background-color: beige; width: 80px; height: 21px;">
                                        Department</td>
                                    <td style="background-color: beige; width: 219px; height: 21px;">
                                        <asp:Label ID="lbldept" runat="server"></asp:Label></td>
                                    <td style="background-color: beige; width: 83px; height: 21px;">
                                        Section</td>
                                    <td style="background-color: beige; width: 500px; height: 21px;">
                                        <asp:Label ID="lblsect" runat="server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="background-color: beige; width: 80px;">
                                        Designation</td>
                                    <td style="background-color: beige; width: 219px;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="width: 66px; background-color: beige">
                                        <asp:Label ID="lblpurpose" runat="server" Width="528px"></asp:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr                                >
                                    <td  style="height: 16px; background-color: beige; width: 80px;">
                                        Revision No:</td>
                                    <td  style="height: 16px; background-color: beige; width: 219px;">
                                        <asp:Label ID="txtrevno" runat="server"></asp:Label>
                                    </td>
                                    <td  style="height: 16px; background-color: beige; width: 83px;">Time Period</td>
                                    <td  style="height: 16px; background-color: beige; width: 500px;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="height: 16px; background-color: beige">
                                        <asp:TextBox ID="txtitem" runat="server" TextMode="MultiLine" Width="281px"></asp:TextBox>
                                        <br />
                ...
                <tr>
                    ...
                    <td background="../../images/bot_mid.gif" height="16" style="width: 668px">
