<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="Halfdayleave.aspx.vb" Inherits="E_Management.Halfdayleave" title="Halfdayleave" %>

<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
<asp:Label id="Label1" runat="server" ForeColor="#C00000" Font-Bold="True" Text="HALF-DAY LEAVE" Font-Underline="True"></asp:Label>
