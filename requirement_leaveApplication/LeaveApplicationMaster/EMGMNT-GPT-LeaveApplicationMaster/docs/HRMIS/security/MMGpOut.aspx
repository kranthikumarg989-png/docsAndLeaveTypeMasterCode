<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="MMGpOut.aspx.vb" Inherits="E_Management.MMGpOut" 
    title="Maruwa Group of Companies - Gate Pass OUT" %>
  <%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Underline="True" ForeColor="#C00000"
        Text="GATEPASS OUT - MARUWA MALAYSIA"></asp:Label><asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
    ...
    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Underline="True" ForeColor="#C00000"
        Text="GATEPASS OUT - MARUWA LIGHTINGS" Visible="False"></asp:Label><asp:GridView ID="GridView3" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        CellPadding="4" DataSourceID="lightingshrmis" ShowFooter="True" ForeColor="#333333" PageSize="25" BorderColor="Gray" BorderWidth="1px" Width="1031px" Visible="False">
            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
            <Columns>
                <asp:BoundField DataField="passno" HeaderText="Passno" SortExpression="passno" />
                <asp:BoundField DataField="empcode" HeaderText="Empcode" SortExpression="empcode" />
                ...
                <asp:TemplateField HeaderText="Speedofmeter" SortExpression="speedofmeter">
                    <ItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" BorderColor="Black" BorderWidth="1px" Height="14px"
                            Text='<%# Bind("speedofmeter") %>' Width="80px"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Actualtimeout">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Out">
                    ...
                    <FooterTemplate>
                        <asp:Button ID="Button1" OnClick="UpdategpApprovalLightings" runat="server" Text="Submit" BackColor="LightSteelBlue" />
                    </FooterTemplate>
                    <ItemTemplate>
                        <asp:CheckBox ID="CheckBox1" runat="server" />
                    </ItemTemplate>
    ...
    <asp:SqlDataSource ID="lightingshrmis" runat="server" ConnectionString="<%$ ConnectionStrings:lightingshrmis %>"
        SelectCommand="SELECT staffgatepass.passno,staffgatepass.outdate , staffgatepass.outtime,staffgatepass.pvehicleno,empmaster.empname,(select(EMPMASTER.DEPARTMENTCODE +'-'+ EMPMASTER.SECTIONCODE))as ds, staffgatepass.empcode, staffgatepass.date1, staffgatepass.purpose, staffgatepass.outdate, staffgatepass.outtime, staffgatepass.indate, staffgatepass.intime, staffgatepass.pvehicleno, staffgatepass.gatepasstype, staffgatepass.location, staffgatepass.mobile, staffgatepass.atimein, staffgatepass.atimeout, staffgatepass.status, staffgatepass.status1, staffgatepass.statusreason, staffgatepass.category, staffgatepass.sectioncode, staffgatepass.department, staffgatepass.approvedby, staffgatepass.remarks, staffgatepass.userid, staffgatepass.speedofmeter, staffgatepass.speedofmeterin, staffgatepass.approveddate, staffgatepass.btnum FROM staffgatepass INNER JOIN empmaster ON staffgatepass.empcode = empmaster.empcode WHERE (staffgatepass.status = 'APPROVED') OR (staffgatepass.status = 'SCHEDULED') ORDER BY staffgatepass.passno">
    </asp:SqlDataSource>
    <br />
    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Underline="True" ForeColor="#C00000"
        Text="GATEPASS OUT - MARUWA MELAKA" Visible="False"></asp:Label><asp:GridView ID="GridView4" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        CellPadding="4" ShowFooter="True" ForeColor="#333333" PageSize="25" BorderColor="Gray" BorderWidth="1px" Width="1031px" Visible="False">
            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
            <Columns>
                <asp:BoundField DataField="passno" HeaderText="Passno" SortExpression="passno" />
                <asp:BoundField DataField="empcode" HeaderText="Empcode" SortExpression="empcode" />
                ...
                <asp:TemplateField HeaderText="Out">
                    ...
                    <FooterTemplate>
                        <asp:Button ID="Button1" OnClick="UpdategpApprovalMelaka" runat="server" Text="Submit" BackColor="LightSteelBlue" />
                    </FooterTemplate>
                    <ItemTemplate>
                        <asp:CheckBox ID="CheckBox1" runat="server" />
                    </ItemTemplate>
    ...
    <asp:SqlDataSource ID="melakahrmis" runat="server" ConnectionString="<%$ ConnectionStrings:MelakaHrmis %>"
        SelectCommand="SELECT staffgatepass.passno,staffgatepass.outdate , staffgatepass.outtime,staffgatepass.pvehicleno,empmaster.empname,(select(EMPMASTER.DEPARTMENTCODE +'-'+ EMPMASTER.SECTIONCODE))as ds, staffgatepass.empcode, staffgatepass.date1, staffgatepass.purpose, staffgatepass.outdate, staffgatepass.outtime, staffgatepass.indate, staffgatepass.intime, staffgatepass.pvehicleno, staffgatepass.gatepasstype, staffgatepass.location, staffgatepass.mobile, staffgatepass.atimein, staffgatepass.atimeout, staffgatepass.status, staffgatepass.status1, staffgatepass.statusreason, staffgatepass.category, staffgatepass.sectioncode, staffgatepass.department, staffgatepass.approvedby, staffgatepass.remarks, staffgatepass.userid, staffgatepass.speedofmeter, staffgatepass.speedofmeterin, staffgatepass.approveddate, staffgatepass.btnum FROM staffgatepass INNER JOIN empmaster ON staffgatepass.empcode = empmaster.empcode WHERE (staffgatepass.status = 'APPROVED') OR (staffgatepass.status = 'SCHEDULED') ORDER BY staffgatepass.passno">
    </asp:SqlDataSource>
    <br />
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Underline="True" ForeColor="#C00000"
        Text="GATEPASS OUT - MARUWA OUTSOURCE"></asp:Label><br />
    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        CellPadding="4" DataSourceID="outHRMIS" ShowFooter="True" ForeColor="#333333" PageSize="25" BorderColor="Gray" BorderWidth="1px" Width="1031px">
        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
        <Columns>
            <asp:BoundField DataField="passno" HeaderText="Passno" SortExpression="passno" />
            <asp:BoundField DataField="empcode" HeaderText="Empcode" SortExpression="empcode" />
            ...
            <asp:TemplateField HeaderText="Out">
                ...
                <FooterTemplate>
                    <asp:Button ID="Button1" OnClick="UpdategpApprovalOutsource" runat="server" Text="Submit" BackColor="LightSteelBlue" />
                </FooterTemplate>
                <ItemTemplate>
                    <asp:CheckBox ID="CheckBox1" runat="server" />
                </ItemTemplate>
    ...
    <asp:SqlDataSource ID="outHRMIS" runat="server" ConnectionString="<%$ ConnectionStrings:OutsourceHRMIS %>"
        SelectCommand="SELECT staffgatepass.passno,staffgatepass.outdate , staffgatepass.outtime,staffgatepass.pvehicleno,empmaster.empname,(select(EMPMASTER.DEPARTMENTCODE +'-'+ EMPMASTER.SECTIONCODE))as ds, staffgatepass.empcode, staffgatepass.date1, staffgatepass.purpose, staffgatepass.outdate, staffgatepass.outtime, staffgatepass.indate, staffgatepass.intime, staffgatepass.pvehicleno, staffgatepass.gatepasstype, staffgatepass.location, staffgatepass.mobile, staffgatepass.atimein, staffgatepass.atimeout, staffgatepass.status, staffgatepass.status1, staffgatepass.statusreason, staffgatepass.category, staffgatepass.sectioncode, staffgatepass.department, staffgatepass.approvedby, staffgatepass.remarks, staffgatepass.userid, staffgatepass.speedofmeter, staffgatepass.speedofmeterin, staffgatepass.approveddate, staffgatepass.btnum FROM staffgatepass INNER JOIN empmaster ON staffgatepass.empcode = empmaster.empcode WHERE (staffgatepass.status = 'APPROVED') OR (staffgatepass.status = 'SCHEDULED') ORDER BY staffgatepass.passno">
    </asp:SqlDataSource>
    &nbsp; &nbsp;&nbsp;
        </asp:Content>
