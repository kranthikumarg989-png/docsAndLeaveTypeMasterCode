<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="MMGpreturn.aspx.vb" Inherits="E_Management.MMGpreturn" 
    title="Maruwa Group of Companies - Gate Pass return" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
<asp:Label id="Label1" runat="server" ForeColor="#C00000" Font-Bold="True" Text="GATEPASS RETURN - MARUWA MALAYSIA" Font-Underline="True"></asp:Label>
    ...
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Underline="True" ForeColor="#C00000"
        Text="GATEPASS RETURN - MARUWA MELAKA" Visible="False"></asp:Label><br />
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" ShowFooter="True" AllowPaging="True" BorderColor="Gray" CaptionAlign="Left" PageSize="25" Visible="False">
        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
        <Columns>
            <asp:BoundField DataField="passno" HeaderText="Passno" SortExpression="passno" />
            <asp:BoundField DataField="empcode" HeaderText="Empcode" SortExpression="empcode" />
            ...
            <asp:TemplateField HeaderText="VehicleMeter &lt;br&gt; Reading" SortExpression="speedofmeterin">
                <ItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" BorderColor="Black" BorderWidth="1px" Text='<%# Bind("speedofmeterin") %>'
            ...
            <asp:TemplateField HeaderText="Return">
                ...
                <FooterTemplate>
                    <asp:Button ID="Button1" OnClick="UpdategpApprovalmel" runat="server" Text="Submit" BackColor="LightSteelBlue" />
                </FooterTemplate>
                <ItemTemplate>
                    <asp:CheckBox ID="cb1" runat="server" />
                </ItemTemplate>
    ...
    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Underline="True" ForeColor="#C00000"
        Text="GATEPASS RETURN - MARUWA LIGHTINGS" Visible="False"></asp:Label><asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4"
        DataSourceID="MaruwaLightings" ForeColor="#333333" ShowFooter="True" AllowPaging="True" BorderColor="Gray" CaptionAlign="Left" PageSize="25" Visible="False">
            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
            <Columns>
                <asp:BoundField DataField="passno" HeaderText="Passno" SortExpression="passno" />
                <asp:BoundField DataField="empcode" HeaderText="Empcode" SortExpression="empcode" />
                ...
                <asp:TemplateField HeaderText="Return">
                    ...
                    <FooterTemplate>
                        <asp:Button ID="Button1" OnClick="UpdategpApprovallit" runat="server" Text="Submit" BackColor="LightSteelBlue" />
                    </FooterTemplate>
                    <ItemTemplate>
                        <asp:CheckBox ID="cb1" runat="server" />
                    </ItemTemplate>
    ...
    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Underline="True" ForeColor="#C00000"
        Text="GATEPASS RETURN - MARUWA OUTSOURCE"></asp:Label><asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CellPadding="4"
        DataSourceID="MaruwaOutsource" ForeColor="#333333" ShowFooter="True" AllowPaging="True" BorderColor="Gray" CaptionAlign="Left" PageSize="25">
            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
            <Columns>
                <asp:BoundField DataField="passno" HeaderText="Passno" SortExpression="passno" />
                <asp:BoundField DataField="empcode" HeaderText="Empcode" SortExpression="empcode" />
                ...
                <asp:TemplateField HeaderText="Return">
                    ...
                    <FooterTemplate>
                        <asp:Button ID="Button1" OnClick="UpdategpApprovalout" runat="server" Text="Submit" BackColor="LightSteelBlue" />
                    </FooterTemplate>
                    <ItemTemplate>
                        <asp:CheckBox ID="cb1" runat="server" />
                    </ItemTemplate>
