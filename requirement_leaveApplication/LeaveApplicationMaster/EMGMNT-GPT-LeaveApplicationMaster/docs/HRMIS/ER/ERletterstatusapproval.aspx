...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
        <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="876px"
            Style="position: relative" Width="1200px" BorderWidth="1px"><cc1:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
            <HeaderTemplate>
                    New letter
                </HeaderTemplate>
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" Style="position: relative; left: 24px; top: 8px;" CellPadding="0" DataSourceID="SqlDataSource1" ForeColor="#333333" gridLines="Vertical" AllowPaging="True" AutoGenerateColumns="False" ShowFooter="True" Width="1031px" Height="1px" BorderColor="Black" BorderWidth="1px" >
            ...
            <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
                ...
                <ContentTemplate>
                    <asp:GridView ID="GridView2" runat="server" CellPadding="1" ForeColor="#333333"  Style="position: relative; left: 24px; top: 8px;" DataSourceID="SqlDataSource2" AllowPaging="True" AutoGenerateColumns="False" ShowFooter="True" Width="1073px" BorderColor="Black" BorderWidth="1px" Height="1px">
            ...
            <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel3">
                ...
                <ControlStyle Font-Underline="True" /></asp:HyperLinkField>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                        SelectCommand="select empcode,lettername,createdby,issuedby,issuedate,ltrim(rtrim(status))as status,sno from HRMIS_ER_MASTER_LETTER_SAVE where status='S'order by sno">
                        </asp:SqlDataSource>
                </ContentTemplate>
            </cc1:TabPanel>
</cc1:TabContainer>
