...
<body>
    ...
    <div>
            ...
            <tr>
                <td colspan="3" style="height: 119px; width: 833px;">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <cc1:HtmlEditor ID="HtmlEditor1" runat="server"  Width="840px" Height="475px" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
            InsertCommand="INSERT INTO [HRMIS_ER_MASTER_LETTER_SAVE]([lettercontents],[empcode],[lettername],[issuedate],[createdby],[status],[lettertype]) VALUES (@lettercontents,@empcode,@lettername,@issuedate,@createdby,@status,@lettertype)">
