...
<body>
    ...
    <table style="z-index: 100; left: 193px; width: 842px; position: absolute; top: 69px;
            height: 430px">
            <tr>
                <td colspan="3" style="width: 1049px">
                    &nbsp;&nbsp;
                    <table id="TABLE1" language="javascript" onclick="return TABLE1_onclick()" style="z-index: 100;
                        ...
                        <tr>
                            <td style="width: 63px; height: 21px; background-color: beige">
                            </td>
            ...
            <tr>
                <td colspan="3" style="height: 154px; width: 1049px;">
                    &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:ScriptManager ID="ScriptManager1" runat="server">
                    ...
                    <cc1:htmleditor id="HtmlEditor1" runat="server" style="z-index: 100; left: 2px; position: absolute;
                        top: 37px" width="838px" Height="395px" DialogButtonBarColor="LightSteelBlue"></cc1:htmleditor>
                    <asp:Button ID="Button1" runat="server" Style="z-index: 101; left: 715px; position: absolute;
                        top: 402px" Text="Clear" BackColor="LightSteelBlue" BorderColor="LightSteelBlue" />
                    <asp:Button ID="Button2" runat="server" Style="z-index: 103; left: 770px; position: absolute;
                        top: 402px" Text="Update" BackColor="LightSteelBlue" BorderColor="LightSteelBlue" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    &nbsp; &nbsp;
                </td>
