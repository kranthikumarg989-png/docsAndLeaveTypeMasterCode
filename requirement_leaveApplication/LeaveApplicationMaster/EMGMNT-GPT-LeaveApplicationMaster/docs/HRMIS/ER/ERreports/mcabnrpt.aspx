<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="mcabnrpt.aspx.vb" Inherits="E_Management.mcabnrpt" 
    title="Untitled Page" %>
                            ...
                            <table>
                                <tr>
                                    <td class="td_head" colspan="2">
                                        <strong>ABNORMAL REPORTS - MEDICAL LEAVE</strong></td>
                                </tr>
                                <tr>
                                    <td style="width: 124px; height: 24px; background-color: beige">
                                        Over All Cases By EmpNo (From April 2004)</td>
                                ...
                                <tr>
                                    <td style="width: 124px; height: 26px; background-color: beige">
                                        Department</td>
                                    <td style="width: 403px; height: 26px">
