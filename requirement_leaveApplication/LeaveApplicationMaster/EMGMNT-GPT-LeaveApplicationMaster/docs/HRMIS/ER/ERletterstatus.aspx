...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHApplication" runat="server">
     <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="2" Height="1271px"
            ...
            <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        Style="position: relative; left: 8px; top: 16px;" BorderColor="#404040" BorderWidth="1px" Height="1px" Width="761px" PageSize="25">
            ...
            <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
                ...
                <ContentTemplate>
                    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        Style="position: relative; left: 16px; top: 12px;" BorderColor="#404040" BorderWidth="1px" Height="1px" Width="756px" PageSize="25">
                        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                        <Columns>
                            <asp:BoundField DataField="slno" HeaderText="Sno" InsertVisible="False" ReadOnly="True"
                                SortExpression="slno" />
            ...
            <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel3">
                ...
                <ContentTemplate>
                    ...
                    AllowPaging="True" AutoGenerateColumns="False" CellPadding="1" DataSourceID="SqlDataSource3" ForeColor="#333333" BorderColor="Black" BorderWidth="1px" Height="1px" Width="742px" PageSize="25">
                        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                        <Columns>
