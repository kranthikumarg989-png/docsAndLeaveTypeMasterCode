<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebForm4.aspx.vb" Inherits="E_Management.WebForm4" %>
...
<body>
    ...
    <div>
        ...
        <table border="1" bordercolor="midnightblue" style="z-index: 104; left: 86px; position: absolute;
            top: 61px; height: 298px; width: 862px;">
            <tr>
            ...
            <tr>
                <td colspan="4" style="height: 266px">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <cc1:htmleditor id="HtmlEditor1" runat="server" height="300px" style="z-index: 100;
                                left: 7px; position: absolute; top: 123px" width="847px"></cc1:htmleditor>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
        ...
        <asp:Button ID="Button2" runat="server" Style="z-index: 105; left: 660px; position: absolute;
            top: 461px" Text="Submit" Width="109px" />
    
    </div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>" 
        InsertCommand="INSERT INTO [HRMIS_CMG_MASTER_LETTER]([lettername],createdyby,revision,createdtime,letterlink) VALUES (@lettername,@createdby,0,@time,@letterlink)" >
        </asp:SqlDataSource>
    </form>
</body>
</html>
