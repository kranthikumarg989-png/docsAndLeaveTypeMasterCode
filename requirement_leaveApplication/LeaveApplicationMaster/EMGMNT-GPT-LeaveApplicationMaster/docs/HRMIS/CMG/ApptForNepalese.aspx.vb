...
Partial Public Class ApptForNepalese
    ...
    Protected Sub Saveaptnepal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Saveaptnepal.Click
        ...
        Response.Redirect("AptLetNepalRpt.aspx")
    ...
    Private Sub Appdetails1()
        ...
        con.Open()
        Cmd = New SqlCommand("delete from cmg_witness_temp", con)
        Cmd.ExecuteNonQuery()
        ...
        If recstatus = True Then
            ...
            Try
                ...
                Dim conn As New SqlConnection(constr)
                conn.Open()
                Cmd = New SqlCommand("insert into cmg_witness_temp (wempno,wempdesig,wempname) values('" & wempno.Text & "','" & wdesig.Text & "','" & wempname.Text & "')", conn)
                Cmd.ExecuteNonQuery()
                'labelmsg.Text = "Details updated"
            Catch ex As SqlException
                labelmsg.Text = ex.Message
