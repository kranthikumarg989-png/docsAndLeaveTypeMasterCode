<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StaffApptLetterD.aspx.vb" Inherits="E_Management.StaffApptLetterD" %>
    ...
    <asp:Label ID="prob" runat="server"></asp:Label><%--<%=entitle%>--%>
              ...
              __designer:dtid="3940739868262513"><TD 
                ...
                align=center __designer:dtid="3940739868262516"><%--<%=request.form("alltype1") %> --%>
                     ...
                     <tr style="font-size: 12pt">
                       <td height="149" colspan="9"><p align="justify">6) Status and Commencement Of Employment Upon successful completion of your probation period, you will be assessed on your performance of your job tasks. Your superior may recommend you for confiramtion of employment under the following criteria
                           : - </p>
                             ...
                             <ul>
                               <blockquote>
                                 <p align="justify">a) Operators level – 3 months </p>
                                   ...
                                   <p align="justify">
                                       c) Supervisors till Engineers level &ndash; 4 months 
                                   </p>
                                   <p align="justify">
                                       d) Executive level and above &ndash; 6 months 
                                   </p>
                               </blockquote>
                             </ul>
                         </ul></td>
