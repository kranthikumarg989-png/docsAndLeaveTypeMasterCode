<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="SpecialIncentive.aspx.vb" Inherits="E_Management.SpecialIncentive" 
    title="Special Incentive Letter" %>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 205px" valign="top">
                                            ...
                                            <asp:RequiredFieldValidator ID="R5" runat="server" ControlToValidate="ltdt" ErrorMessage="!"></asp:RequiredFieldValidator></td>
                                        <td align="left" style="width: 364px; background-color: beige" valign="top">
                                            Eff. From Date</td>
                                        <td align="left" style="width: 404px" valign="top">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" colspan="3" style="height: 40px" valign="middle">
                                            <asp:TextBox ID="oldpall" runat="server"></asp:TextBox>&nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" style="width: 295px; height: 40px; background-color: beige" valign="top">
                                    ...
                                    <tr>
                                        <td align="left" style="width: 295px; height: 28px; background-color: beige" valign="top">
                                            PFP Allowance</td>
                                        <td align="left" colspan="3" valign="middle">
                                            <asp:TextBox ID="pfpall" runat="server"></asp:TextBox>&nbsp;
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            <asp:Label ID="labelmsg" runat="server"></asp:Label><br />
                            &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<asp:Button ID="IncSPLsave" runat="server" Text="SAVE & PRINT" />
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</td>
                    </tr>
                </table>
