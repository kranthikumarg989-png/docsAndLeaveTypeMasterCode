<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ProbLetForPromotees.aspx.vb" Inherits="E_Management.ProbLetForPromotees" 
    title="Letter of probation for promotees" %>
...
<table id="TABLE2" style="height: 292px" border="1">
        <tr>
            <td style="height: 297px; width: 465px;" valign="top" align="center">
                <table id="TABLE1" onclick="return TABLE1_onclick()" cellpadding="1" cellspacing="1">
                    <tr>
                        <td colspan="2" style="height: 12px" valign="top" align="left" class="td_head">
                            &nbsp;LETTER OF PROBATION FOR PROMOTEES<br />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 398px;" valign="top" align="left" colspan="1">
                            ...
                            <asp:RequiredFieldValidator ID="R5" runat="server" ControlToValidate="letdt" ErrorMessage="!"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td style="width: 137px; background-color: beige; height: 17px;" valign="top" align="left">
                            Effective Date</td>
                        <td style="width: 398px" valign="top" align="left">
                            <asp:TextBox ID="eff_frm" runat="server" MaxLength="3" Width="182px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="R6" runat="server" ControlToValidate="eff_frm" ErrorMessage="!"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td align="left" style="width: 137px; height: 28px; background-color: beige" valign="top">
                            New Designation</td>
                        <td align="left" style="width: 398px" valign="top">
                            <asp:DropDownList ID="newdesig" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1"
                                DataTextField="designationname" DataValueField="designationname" Width="316px">
                ...
                <asp:Button ID="Saveprobpromo" runat="server" Text="SAVE & PRINT" /></td>
        </tr>
    </table>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                    SelectCommand="SELECT DISTINCT [designationname] FROM [designation] ORDER BY [designationname]">
                </asp:SqlDataSource>
