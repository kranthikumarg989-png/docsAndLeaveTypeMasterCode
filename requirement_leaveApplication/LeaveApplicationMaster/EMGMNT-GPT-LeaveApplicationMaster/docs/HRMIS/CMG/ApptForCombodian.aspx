<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ApptForCombodian.aspx.vb" Inherits="E_Management.ApptForCombodian" 
    title="Appointment Letter For Combodian" %>
...
<table id="TABLE2" style="height: 292px" border="1">
        <tr>
            <td style="height: 335px; width: 666px;" valign="top" align="center">
                <table id="TABLE1" onclick="return TABLE1_onclick()" cellpadding="1" cellspacing="1">
                    <tr>
                        <td colspan="4" style="height: 12px" valign="top" align="left" class="td_head">
                            &nbsp;APPOINTMENT LETTER FOR COMBODIAN</td>
                    </tr>
                    <tr>
                ...
                <asp:Button ID="Saveaptcombodia" runat="server" Text="SAVE & PRINT" /></td>
        </tr>
    </table>
