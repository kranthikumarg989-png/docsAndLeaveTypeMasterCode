<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="probpromotiontrial.aspx.vb" Inherits="E_Management.probpromotiontrial" 
    title="Extension of Probationary Promotion/ Trial Period" %>
                ...
                <table id="TABLE1" onclick="return TABLE1_onclick()" cellpadding="1" cellspacing="1">
                    <tr>
                        <td colspan="2" style="height: 12px" valign="top" align="left" class="td_head">
                            &nbsp;EXTENSION OF PROBATIONARY PROMOTION/ TRIAL PERIOD<br />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="left" class="td_head" colspan="2" style="height: 21px" valign="top">
                            EXTENSION OF PROBATIONARY PROMOTION/ TRIAL PERIOD</td>
                    </tr>
                    <tr>
                        <td style="width: 335px; background-color: beige; height: 30px;" valign="top" align="left">
                            Date of Issue</td>
                    ...
                    <tr>
                        <td align="left" style="width: 335px; height: 40px; background-color: beige" valign="top">
                            New Designation</td>
                        <td align="left" style="width: 398px; height: 40px;" valign="top">
                            ...
                            <asp:RequiredFieldValidator ID="V4" runat="server" ControlToValidate="newdesig"
                                ErrorMessage="!" Width="1px"></asp:RequiredFieldValidator></td>
                    </tr>
                </table>
                <asp:Label ID="labelmsg" runat="server"></asp:Label><br />
                <asp:Button ID="Savepptrialext" runat="server" Text="SAVE & PRINT" /></td>
        </tr>
    </table>
