...
Public Class emp_legalagreements
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "emp_legalagreements.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedemp_legalagreements
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As emp_legalagreements = New emp_legalagreements
        rpt.Site = Me.Site
        Return rpt
    End Function
