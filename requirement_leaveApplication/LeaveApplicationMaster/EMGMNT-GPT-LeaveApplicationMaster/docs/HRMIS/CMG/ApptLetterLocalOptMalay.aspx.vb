...
Partial Public Class ApptLetterLocalOptMalay
    ...
    Protected Sub ALOMsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ALOMsave.Click
        Dim dd1 As String
        Dim dd As String
        ...
        If recstatus = True Then
            ...
            End If
        End If
        Session("OMRname") = empno.Text.Trim

        MyGlobal.db_close()
        If RadioButtonList1.SelectedValue = "O" Then
            Response.Redirect("AptLocOptMalayRpt.aspx")
        ElseIf RadioButtonList1.SelectedValue = "TO" Then
            Response.Redirect("AptTechOptMalayRpt.aspx")
        End If
