...
Public Class emp_contractextension
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "emp_contractextension.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedemp_contractextension
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As emp_contractextension = New emp_contractextension
        rpt.Site = Me.Site
        Return rpt
    End Function
