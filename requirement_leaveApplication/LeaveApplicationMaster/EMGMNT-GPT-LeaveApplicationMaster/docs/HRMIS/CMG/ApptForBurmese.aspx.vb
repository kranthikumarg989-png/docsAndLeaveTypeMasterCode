...
Partial Public Class ApptForBurmese
    ...
    Protected Sub Saveaptburma_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Saveaptburma.Click
        Dim dd1 As String
        Dim dd As String
        ...
        Response.Redirect("AptLetBurmaRpt.aspx")
    ...
    Private Sub Appdetails1()
        ...
        Con.Open()
        Cmd = New SqlCommand("delete from cmg_witness_burmtemp", con)
        Cmd.ExecuteNonQuery()
        ...
        If recstatus = True Then
            ...
            Try
                ...
                Dim conn As New SqlConnection(constr)
                conn.Open()
                Cmd = New SqlCommand("insert into cmg_witness_burmtemp (wempno,wempdesig,wempname) values('" & wempno.Text & "','" & wdesig.Text & "','" & wempname.Text & "')", conn)
                Cmd.ExecuteNonQuery()
                'labelmsg.Text = "Details updated"
            Catch ex As SqlException
                labelmsg.Text = ex.Message
