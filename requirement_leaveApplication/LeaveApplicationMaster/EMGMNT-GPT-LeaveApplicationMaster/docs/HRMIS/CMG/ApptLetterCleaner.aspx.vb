...
Partial Public Class ApptLetterCleaner
    ...
    Protected Sub Saveaptcleaner_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Saveaptcleaner.Click
        Dim dd1 As String
        Dim dd As String
        ...
        Response.Redirect("AptLetCleanerRpt.aspx")
