<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Promotion PFPLetter.aspx.vb" Inherits="E_Management.Promotion_PFPLetter" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Promotion Letter Based on PFP</title>
</head>
<body>
   ...
   <table width="612" border="0" cellspacing="0">
                  ...
                  <td>
                      <table border="0" cellspacing="0" width="610">
                          <tr>
                              ...
                              <td width="345">
                                  <a href="emp_main.asp">
                                      <img border="0" height="42" src="../../images/maruwaAnimLogo.gif" width="161" /></a></td>
                              <td width="62">
                                  Ref. No.:</td>
              ...
              <tr class="style2">
                  <td>
                      <table border="0" cellspacing="0" width="609">
                          <tr>
                              <td>
                                  &nbsp;</td>
                              <td width="120">
...
__designer:dtid="1407439308062750">Designation : <asp:Label id="desig" __designer:dtid="1407439308062751" runat="server" Font-Bold="False"></asp:Label><%--<%=olddesig%>--%></td>
              ...
              <tr class="style2">
                <td><table width="613" border="0" cellspacing="0">
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4"><p align="justify">It is with great pleasure to inform you that you had shown examplary performance and thus have developed yourself while serving the Company.</p></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">&nbsp;</td>
                    ...
                    <tr>
                      <%--<%if request.form("olddesignation")<>"Clerk" or request.form("olddesignation")<>"Driver" or request.form("olddesignation")<>"Line Leader" or request.form("olddesignation")<>"Operator" or request.form("olddesignation")<>"Security Guard" or request.form("olddesignation")<>"Senior Clerk" or request.form("olddesignation")<>"Senior L/Leader" or request.form("olddesignation")<>"Technician" or request.form("olddesignation")<>"Cleaner" or request.form("olddesignation")<>"Asst Line Leader" or request.form("olddesignation")<>"Asst Technician" or request.form("olddesignation")<>"Warden" or request.form("olddesignation")<>"Receiptionist" or request.form("olddesignation")<>"Shift Leader"  then%>--%>
                      <td>&nbsp;</td>
                      <td colspan="4"><div align="justify">As such, effective from &nbsp;<asp:Label ID="dteff" runat="server"></asp:Label><strong>&nbsp;<%--<%=request.form("date10")%>--%></strong>,&nbsp; the management is pleased to promote you as a
                          <asp:Label ID="newdesig" runat="server"></asp:Label>.</div></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4"><%--<%=request.form("newdesignation1")%> --%>In line with your new designation, you are now part of the Pay for Performance scheme.</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4"><div align="left">Your Monthly Salary is as below : </div></td>
                    </tr>
<%--                    <%end if%>
--%>                    <%'if request.form("olddesignation")="Clerk" or request.form("olddesignation")="Driver" or request.form("olddesignation")="Line Leader" or request.form("olddesignation")="Operator" or request.form("olddesignation")="Security Guard" or request.form("olddesignation")="Senior Clerk" or request.form("olddesignation")="Senior L/Leader" or request.form("olddesignation")="Technician" or request.form("olddesignation")="Cleaner" or request.form("olddesignation")="Asst Line Leader" or request.form("olddesignation")="Asst Technician" or request.form("olddesignation")="Warden" or request.form("olddesignation")="Receiptionist" or request.form("olddesignation")="Shift Leader" and request.form("newdesignation")="Asst Engineer" or request.form("newdesignation")="Officer" or request.form("newdesignation")="Senior Technician" or request.form("newdesignation")="Asst Officer" or request.form("newdesignation")="Asst Supervisor" or request.form("newdesignation")="Supervisor" 
				    ...
				    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">As such, effective from <strong><%=request.form("date2")%></strong>, the management is pleased to promote you as a </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4"><strong><%=request.form("newdesignation")%></strong> and being part of the Pay for Performance scheme. </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      ...
                      <td colspan="4"><table width="454" border="0" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td>RM</td>
                              <td>
                                  :
                                  <asp:Label ID="obs" runat="server"></asp:Label></td>
                          </tr>
                          <tr>
                            <td height="20">&nbsp;</td>
                            ...
                            <td>RM</td>
                              <td>
                                  :
                                  <asp:Label ID="opa" runat="server"></asp:Label></td>
                          </tr>
                         <%-- <% if request.form("pfp1")<>"" then %>
                          ...
                          <tr>
                            ...
                            <td width="18">RM</td>
                              <td width="92">
                                  :
                                  <asp:Label ID="nbs" runat="server"></asp:Label></td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            ...
                            <td>RM</td>
                              <td>
                                  :
                                  <asp:Label ID="npa" runat="server"></asp:Label></td>
                          </tr>
                         <%-- <%if request.form("pfp2")<>"" then%>--%>
                          <tr>
                            <td>&nbsp;</td>
                            <td>PFP Allowance </td>
                            <td>RM</td>
                              <td>
                                  :
                                  <asp:Label ID="npfpall" runat="server"></asp:Label></td>
                          </tr>
                         <%-- <%end if%>--%>
                          <tr>
                            <td>&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td style="height: 21px">Total Salary </td>
                            <td style="height: 21px">RM</td>
                              <td style="height: 21px">
                                  :
                                  <asp:Label ID="totsal" runat="server"></asp:Label></td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">In line with the management's effort to Pay for Performance, we are pleased to announce that PFP Allowance will be based on your monthly performance achievement %, and your grading will be as specified below.</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">&nbsp;</td>
                    ...
                    <tr>
                      <td colspan="2">&nbsp;</td>
                      <td><div align="center"><strong><u>PFP Achievement % </u></strong></div></td>
                      <td><div align="center"><strong><u>Grade</u></strong></div></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                      <td><div align="center">100% ~ 95%</div></td>
                      <td><div align="center">A</div></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                      <td><div align="center">94% ~ 85%</div></td>
                      <td><div align="center">B</div></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                      <td><div align="center">84% ~ 75%</div></td>
                      <td><div align="center">C</div></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                      <td><div align="center">74% ~ 65%</div></td>
                      <td><div align="center">D</div></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                      <td><div align="center">64% ~ and below </div></td>
