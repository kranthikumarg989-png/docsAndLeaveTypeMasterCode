...
Public Class emp_probforpromotees
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "emp_probforpromotees.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedemp_probforpromotees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As emp_probforpromotees = New emp_probforpromotees
        rpt.Site = Me.Site
        Return rpt
    End Function
