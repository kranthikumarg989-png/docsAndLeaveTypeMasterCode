<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="Increment.aspx.vb" Inherits="E_Management.Increment" 
                ...
                <table id="TABLE2" border="1">
                    <tr>
                        <td style="width: 654px; height: 198px; text-align: center;" align="center" valign="top">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 404px" valign="top">
                                            ...
                                            <asp:RequiredFieldValidator ID="R7" runat="server" ControlToValidate="effdt" ErrorMessage="!"></asp:RequiredFieldValidator></td>
                                    </tr>
                                    <tr>
                            ...
                            &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<asp:Button ID="Incsave" runat="server" Text="SAVE & PRINT" />
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</td>
                    </tr>
                </table>
