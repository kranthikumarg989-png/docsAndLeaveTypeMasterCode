<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ApptForNepalese.aspx.vb" Inherits="E_Management.ApptForNepalese" 
    title="Appointment Letter For Nepalese" %>
...
<table id="TABLE2" style="height: 292px" border="1">
        <tr>
            <td style="height: 335px; width: 666px;" valign="top" align="center">
                <table id="TABLE1" onclick="return TABLE1_onclick()" cellpadding="1" cellspacing="1">
                    <tr>
                        <td colspan="4" style="height: 12px" valign="top" align="left" class="td_head">
                            &nbsp;APPOINTMENT LETTER FOR NEPALESE</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 404px" valign="top">
                            ...
                            <asp:RequiredFieldValidator ID="R6" runat="server" ControlToValidate="letdt" ErrorMessage="!"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" style="width: 305px" valign="top">
                            ...
                            <asp:RequiredFieldValidator ID="R8" runat="server" ControlToValidate="eff_to" ErrorMessage="!"></asp:RequiredFieldValidator></td>
                ...
                <asp:Button ID="Saveaptnepal" runat="server" Text="SAVE & PRINT" /></td>
        </tr>
    </table>
