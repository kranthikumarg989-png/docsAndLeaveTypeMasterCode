<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ApptLetterForStaff.aspx.vb" Inherits="E_Management.ApptLetterForStaff" 
    title="Appointment Letter for Staff" %>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td align="left" colspan="3" style="height: 21px" class="td_head">
                                        Appointment Letter For Staff</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="right" colspan="2" style="width: 185px; height: 26px; text-align: left; background-color: beige">
                                        <asp:DropDownList ID="DDL1" runat="server" AppendDataBoundItems="True" AutoPostBack="True">
                                            <asp:ListItem Value="-1">---Select---</asp:ListItem>
                                            <asp:ListItem>Food Allowance</asp:ListItem>
                                            <asp:ListItem>Attendance Allowance</asp:ListItem>
                                            <asp:ListItem>Fixed Shift Allowance</asp:ListItem>
                                        </asp:DropDownList></td>
                                    <td align="right" colspan="1" style="width: 285px; height: 26px; text-align: left">
                                        <asp:TextBox ID="all1" runat="server" AutoPostBack="True"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td align="right" colspan="2" style="width: 185px; height: 26px; text-align: left; background-color: beige">
                                    ...
                                    <td align="right" colspan="1" style="width: 285px; height: 26px; text-align: left">
                                        <asp:TextBox ID="all2" runat="server" AutoPostBack="True"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td align="right" colspan="2" style="width: 185px; height: 26px; text-align: left; background-color: beige">
                                ...
                                <tr>
                                    <td align="right" colspan="3" style="height: 51px; text-align: center">
                                        ...
                                        &nbsp;<asp:Button ID="showaptstaff" runat="server" SkinID="buttonskin1" Text="SAVE & PRINT" /></td>
                                </tr>
                            </table>
                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
