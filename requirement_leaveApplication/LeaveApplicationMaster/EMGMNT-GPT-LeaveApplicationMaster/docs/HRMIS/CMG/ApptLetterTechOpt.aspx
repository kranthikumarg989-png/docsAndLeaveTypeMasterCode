<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ApptLetterTechOpt.aspx.vb" Inherits="E_Management.ApptLetterTechOpt" 
    title="Appointment Letter Technical Operator Malay" %>
                                ...
                                <tbody>
                                    <tr>
                                        <td align="left" class="td_head" colspan="4" style="height: 12px; text-align: center"
                                            valign="top">
                                            APPOINTMENT LETTER FOR TECHNICAL OPERATORS - MALAY</td>
                                    </tr>
                                    <tr>
