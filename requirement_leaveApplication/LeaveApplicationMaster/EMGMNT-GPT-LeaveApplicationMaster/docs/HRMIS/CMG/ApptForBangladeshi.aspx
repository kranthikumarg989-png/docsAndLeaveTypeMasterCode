<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ApptForBangladeshi.aspx.vb" Inherits="E_Management.ApptForBangladeshi" 
    title="Appointment Letter For Bangladeshi" %>
...
<table id="TABLE2" style="height: 292px" border="1">
        <tr>
            <td style="height: 335px; width: 666px;" valign="top" align="center">
                <table id="TABLE1" onclick="return TABLE1_onclick()" cellpadding="1" cellspacing="1">
                    <tr>
                        <td colspan="4" style="height: 12px" valign="top" align="left" class="td_head">
                            &nbsp;APPOINTMENT LETTER FOR BANGLADESHI</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 404px" valign="top">
                            ...
                            <asp:RequiredFieldValidator ID="R4" runat="server" ControlToValidate="letdt" ErrorMessage="!"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" style="width: 305px; height: 30px;" valign="top">
                            <asp:TextBox ID="eff_to" runat="server" Width="178px"></asp:TextBox></td>
                        <td align="left" style="background-color: beige; width: 364px; height: 30px;" valign="top">
                        </td>
                        <td align="left" style="width: 404px; height: 30px;" valign="top">
                        </td>
                    </tr>
                ...
                <asp:Button ID="Saveaptbangla" runat="server" Text="SAVE & PRINT" /></td>
        </tr>
    </table>
