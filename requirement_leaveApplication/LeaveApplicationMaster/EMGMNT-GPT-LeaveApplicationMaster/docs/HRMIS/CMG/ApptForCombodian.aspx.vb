...
Partial Public Class ApptForCombodian
    ...
    Protected Sub Saveaptcombodia_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Saveaptcombodia.Click
        Dim dd1 As String
        Dim dd As String
        ...
        Response.Redirect("AptLetCombodiaRpt.aspx")
    ...
    Private Sub Appdetails1()
        ...
        Con.Open()
        Cmd = New SqlCommand("delete from cmg_witness_combodiatemp", con)
        Cmd.ExecuteNonQuery()
        ...
        If recstatus = True Then
            ...
            Try
                ...
                Dim conn As New SqlConnection(constr)
                conn.Open()
                Cmd = New SqlCommand("insert into cmg_witness_combodiatemp (wempno,wempdesig,wempname) values('" & wempno.Text & "','" & wempname.Text & "','" & wdesig.Text & "')", conn)
                Cmd.ExecuteNonQuery()
                'labelmsg.Text = "Details updated"
            Catch ex As SqlException
                labelmsg.Text = ex.Message
