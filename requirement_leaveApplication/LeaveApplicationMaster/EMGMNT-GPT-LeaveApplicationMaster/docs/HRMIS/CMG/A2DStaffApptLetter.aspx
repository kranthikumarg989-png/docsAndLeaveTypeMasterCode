<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="A2DStaffApptLetter.aspx.vb" Inherits="E_Management.A2DStaffApptLetter" %>
    ...
    <asp:Label ID="prob" runat="server"></asp:Label><%--<%=entitle%>--%>
                   ...
                   <!--  <tr>
                     ...
                     <tr>
                       ...
                       <td style="width: 347px; height: 21px;">&nbsp;</td>
                       <td style="height: 21px" >&nbsp;</td>
                       <td style="height: 21px">&nbsp;</td>
                     </tr>
                     <tr>
                       ...
                       <td style="width: 347px"><div align="right"></div>
                       </td>
                     ...
                     <tr>
                       ...
                       <td style="width: 347px; height: 21px;"><div align="right">
                           &nbsp;</div></td>
                     ...
                     <tr>
                       <td style="height: 23px; width: 334px; text-align: right;" valign="top">&nbsp;<asp:Label ID="allow1" runat="server"></asp:Label></td>
                       <td style="height: 23px; width: 26px;" valign="top">
                           <asp:Label ID="a1colon" runat="server" Width="1px"></asp:Label></td>
					   <td style="height: 23px; width: 67px;" valign="top"><%--<%=request.form("alltype1") %> --%>
                           <%--<%end if%>
              ...
              __designer:dtid="3940739868262513"><TD 
                ...
                align=center __designer:dtid="3940739868262516"><%--<%=request.form("alltype1") %> --%>
                     ...
                     <td style="width: 186px; height: 23px" valign="middle">
                           <asp:Label ID="all1" runat="server"></asp:Label><br />
                         _______</td>
					 ...
					 <%if request.form("alltype2") <> "E" then%>--%>
                         ...
                         <tr>
                             ...
                             <td style="width: 347px; height: 2px">
                             </td>
                             <td style="height: 2px">
                             </td>
                             <td style="height: 2px">
                     ...
                     <tr><td style="height: 2px; width: 334px;" valign="bottom">
                         ...
                         <td style="width: 347px; height: 2px; font-size: 12pt;" valign="bottom">
                             &nbsp; &nbsp;</td>
                         <td style="height: 2px; width: 347px; font-size: 12pt;" valign="bottom">
                             &nbsp;</td>
                     ...
                     <tr style="font-size: 12pt">
                       <td height="72" colspan="9"><div align="justify">18)Clinic</div>
                             ...
                             <ul>
                               <blockquote>
                                 <p align="justify">a) Operators level – 3 months </p>
                                   ...
                                   <p align="justify">
                                       c) Supervisory till Officer level - 4 months of probation period</p>
                                   <p>
                                       d) Engineer level - 6 months of probation period</p>
                                   <p>
                                       e) Asst.Manager Level and above - 6 months of probation period</p>
                                   <p>
                                       &nbsp;</p>
                               </blockquote>
                             </ul>
                     ...
                     <tr style="font-size: 12pt">
                       <td colspan="9"><p align="justify">22) If you agree to the above terms and conditions of employment, kindly indicate your acceptance by signing and returning the duplicate copy of this letter. </p>
                     ...
                     <tr style="font-size: 12pt">
                       <td height="113" style="width: 334px"><p align="justify">_______________________________</p>
                           <p align="justify"><strong> Seenivasalu A/L Venugopal </strong></p>
                       ...
                       <td height="113" style="width: 347px">&nbsp;</td>
                       <td height="113">&nbsp;</td>
                       <td height="113">&nbsp;</td>
                     </tr>
                     <tr style="font-size: 12pt">
