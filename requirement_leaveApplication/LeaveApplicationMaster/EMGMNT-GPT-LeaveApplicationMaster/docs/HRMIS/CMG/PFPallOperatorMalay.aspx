<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="PFPallOperatorMalay.aspx.vb" Inherits="E_Management.PFPallOperatorMalay" 
    title="PFP Allowance Operator(Malay)"%>
...
<table id="TABLE2" style="height: 292px" border="1">
        <tr>
            <td style="width: 666px;" valign="top" align="center">
                <table id="TABLE1" onclick="return TABLE1_onclick()" cellpadding="1" cellspacing="1">
                    <tr>
                        <td colspan="4" style="height: 12px" valign="top" align="left" class="td_head">
                            &nbsp;NOTIFICATION LETTER ON PAY FOR PERFORMANCE ALLOWANCE - OPERATOR (MALAY)</td>
                    </tr>
                    <tr style="color: #000000">
                        <td align="left" style="width: 295px; height: 28px; background-color: beige" valign="top">
                            Employee No</td>
                        <td align="left" valign="top">
                            <asp:TextBox ID="empcode" runat="server" AutoPostBack="True" MaxLength="6" Width="176px"></asp:TextBox>
