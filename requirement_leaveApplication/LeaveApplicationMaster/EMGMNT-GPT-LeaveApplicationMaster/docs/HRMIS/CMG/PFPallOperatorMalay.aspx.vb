...
Partial Public Class PFPallOperatorMalay
    ...
    Protected Sub SavePFPoptEng_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SavePFPoptEng.Click
        ...
        'SELECT   resigned, nationality, designation, departmentcode, empcode, empname FROM  empmaster WHERE (resigned <> 'Y') AND (designation = 'OPerator') AND (departmentcode = '9010') and ((nationality = 'INDO')  OR (nationality = 'MAL'))
        ...
        Response.Redirect("lettermalay.aspx")
