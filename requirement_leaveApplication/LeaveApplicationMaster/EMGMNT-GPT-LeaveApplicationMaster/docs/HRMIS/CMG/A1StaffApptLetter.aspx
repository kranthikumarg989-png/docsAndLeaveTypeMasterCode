<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="A1StaffApptLetter.aspx.vb" Inherits="E_Management.A1StaffApptLetter" %>
...
<body style="font-family: Times New Roman">
          ...
          %>--%>
           ...
           <tr class="style2">
             <td><table width="609" border="0" cellspacing="0">
                 <tr>
                   <td style="height: 21px; width: 40px;">&nbsp;</td>
    ...
    <asp:Label ID="prob" runat="server"></asp:Label><%--<%=entitle%>--%>
                  ...
                  <!--   <tr>
                     ...
                     <tr>
                       <td style="width: 334px; height: 24px; text-align: right;" align="center">
                           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                           &nbsp; &nbsp;&nbsp; Basic Salary&nbsp;</td>
                       ...
                       <td style="width: 67px; height: 24px">
                         ...
                         <td style="width: 347px; height: 24px">
                         </td>
                       <td style="width: 47px; height: 24px;"><div align="right">
                           &nbsp;</div></td>
                       <td style="height: 24px"><div align="right"><%--<%=a%>--%></div></td>
                       <td style="height: 24px"></td>
                     </tr>
					 <%--<%
					 if request.form("position")<>"0" and request.form("position")<>"" then %>--%>
                       <tr>
                           <td align="center" style="width: 334px; height: 17px; text-align: right">
                           ...
                           <td style="width: 186px; height: 17px">
                               <asp:Label ID="pall" runat="server"></asp:Label></td>
					 ...
					 <%if request.form("alltype1") <> "E" then %>--%>
                       ...
                       <tr>
                           ...
                           <td style="width: 186px" valign="middle">
                               ...
                               ________</span></td>
                           <td style="width: 347px" valign="middle">
                           </td>
                           <td style="width: 47px">
                           </td>
                           <td>
                     ...
                     <tr style="font-size: 12pt">
                       <td colspan="9"><div align="justify">
                           22) All other terms and benefits shall be as stipulated in the Employment Act &amp; Regulation 1955.</div></td>
                     </tr>
                     <tr style="font-size: 12pt">
                     ...
                     <tr style="font-size: 12pt">
                       <td colspan="9"><p align="justify">
                           23) If you agree to the above terms and conditions of employment, kindly indicate your acceptance by signing and returning the duplicate copy of this letter. </p>
                     ...
                     <tr style="font-size: 12pt">
                       <td height="113" style="width: 334px"><p align="justify">_______________________________</p>
                           ...
                           <p align="justify"> CHEIF EXECUTIVE OFFICER </p></td>
