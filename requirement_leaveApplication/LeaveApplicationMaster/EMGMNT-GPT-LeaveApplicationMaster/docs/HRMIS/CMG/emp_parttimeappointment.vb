...
Public Class emp_parttimeappointment
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "emp_parttimeappointment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedemp_parttimeappointment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As emp_parttimeappointment = New emp_parttimeappointment
        rpt.Site = Me.Site
        Return rpt
    End Function
