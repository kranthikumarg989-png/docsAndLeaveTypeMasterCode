...
Partial Public Class ProbPromoTrialRpt
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim crReportDocument As emp_probpromotrial
        ...
        crReportDocument = New emp_probpromotrial
        ...
        crReportDocument.RecordSelectionFormula = "{emp_probationpromotionextend.empcode} = '" & ename & "'"
