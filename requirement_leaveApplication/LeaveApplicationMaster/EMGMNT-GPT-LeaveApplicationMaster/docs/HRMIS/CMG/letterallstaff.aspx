<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="letterallstaff.aspx.vb" Inherits="E_Management.letterallstaff" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>PFP Allowance - Staff (Letter)</title>
</head>
<body>
    ...
    <tr>
      <td colspan="5"><div align="center"><strong>NOTIFICATION LETTER ON PAY FOR PERFORMANCE ALLOWANCE (STAFF) </strong></div></td>
    </tr>
    <tr>
    ...
    <tr class="style2">
      <td colspan="5"><div align="justify">Pursuant to this, your provisional allowance of amount of RM   
      ...
      <td colspan="5"><div align="justify">
        <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td><div align="center"><strong>PFP ACHIEVEMENT </strong></div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><div align="center">99 - 80 </div></td>
              <td><div align="center">B</div></td>
              <td><div align="center">80%</div></td>
            </tr>
            <tr>
              <td><div align="center">79 - 60 </div></td>
              <td><div align="center">C</div></td>
              <td><div align="center">60%</div></td>
            </tr>
            <tr>
              <td><div align="center">59 - 40 </div></td>
              <td><div align="center">D</div></td>
              <td><div align="center">5%</div></td>
            </tr>
            <tr>
              <td><div align="center">39 &amp; Below </div></td>
    ...
    <tr class="style2">
      <td colspan="5"><div align="justify">With Regards to the above, the management would also like to inform you that with effect from&nbsp;<br />
          <asp:Label ID="edate2" runat="server"></asp:Label>
          there will be no fixed yearly increment. </div></td>
    </tr>
    <tr class="style2">
      <td colspan="5">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td colspan="5" style="height: 21px"><div align="justify"></div></td>
    </tr>
    <tr>
      <td colspan="5"><div align="justify"></div></td>
    </tr>
    ...
    <tr>
      ...
      <td width="302"><img src="../../images/anthony.jpg" width="82" height="65"></td>
