<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="LetterOfCertification.aspx.vb" Inherits="E_Management.LetterOfCertification" 
                ...
                <table id="TABLE2" border="1">
                    <tr>
                        <td style="width: 654px; height: 198px; text-align: center;" align="center" valign="top">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" colspan="3" valign="top">
                                            ...
                                            &nbsp;<asp:RequiredFieldValidator ID="R5" runat="server" ControlToValidate="letdt"
                            ...
                            &nbsp; &nbsp; &nbsp;
                            <asp:Button ID="LoCsave" runat="server" Text="SAVE & PRINT" />
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</td>
                    </tr>
                </table>
