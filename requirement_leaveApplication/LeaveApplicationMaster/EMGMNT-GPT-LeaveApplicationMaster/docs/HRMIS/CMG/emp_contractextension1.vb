...
Public Class emp_contractextension1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "emp_contractextension1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedemp_contractextension1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As emp_contractextension1 = New emp_contractextension1
        rpt.Site = Me.Site
        Return rpt
    End Function
