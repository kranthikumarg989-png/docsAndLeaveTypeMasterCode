<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConfidentialAgr.aspx.vb" Inherits="E_Management.ConfidentialAgr" %>
...
<body>
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="emp_legalagreements.rpt">
        </Report>
