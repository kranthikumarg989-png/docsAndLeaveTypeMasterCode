...
Public Class emp_bangladeshiletter
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "emp_bangladeshiletter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedemp_bangladeshiletter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As emp_bangladeshiletter = New emp_bangladeshiletter
        rpt.Site = Me.Site
        Return rpt
    End Function
