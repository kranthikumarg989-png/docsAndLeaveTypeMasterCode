...
Public Class emp_combodianletter
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "emp_combodianletter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedemp_combodianletter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As emp_combodianletter = New emp_combodianletter
        rpt.Site = Me.Site
        Return rpt
    End Function
