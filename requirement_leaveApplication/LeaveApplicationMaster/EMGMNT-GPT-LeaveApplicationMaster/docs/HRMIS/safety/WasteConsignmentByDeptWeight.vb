...
Public Class WasteConsignmentByDeptWeight
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "WasteConsignmentByDeptWeight.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWasteConsignmentByDeptWeight
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WasteConsignmentByDeptWeight = New WasteConsignmentByDeptWeight
        rpt.Site = Me.Site
        Return rpt
    End Function
