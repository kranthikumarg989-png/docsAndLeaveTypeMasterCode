<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="requestordetails.aspx.vb" Inherits="E_Management.requestordetails" 
    title="Untitled Page" %>
...
<table id="TABLE2" border="2" >
    ...
    <tr>
        <td align="left" colspan="1" rowspan="1" style="height: 19px; text-align: center; background-color: beige;" 
            valign="top">
            <asp:Label ID="Label10" runat="server" Font-Underline="True" ForeColor="Maroon" Text="SCHEDULE WASTE CONSIGNMENT DETAILS"></asp:Label>
        </td>
    </tr>
    <tr>
        ...
        <td align="center" style="text-align: left; height: 134px;" valign="top">
            ...
            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                    SelectCommand="SELECT items, quantity, total, remarks, weight, recordno FROM Safety_schedulewasteconsignmentdetails WHERE (recordno = @rno)">
                    <SelectParameters>
