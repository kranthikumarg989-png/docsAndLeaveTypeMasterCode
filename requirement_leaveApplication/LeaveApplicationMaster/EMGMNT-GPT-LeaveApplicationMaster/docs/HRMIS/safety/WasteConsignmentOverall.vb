...
Public Class WasteConsignmentOverall
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "WasteConsignmentOverall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWasteConsignmentOverall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WasteConsignmentOverall = New WasteConsignmentOverall
        rpt.Site = Me.Site
        Return rpt
    End Function
