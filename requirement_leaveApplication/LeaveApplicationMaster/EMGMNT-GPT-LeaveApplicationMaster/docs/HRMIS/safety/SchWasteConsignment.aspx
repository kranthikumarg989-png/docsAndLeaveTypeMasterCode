<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="SchWasteConsignment.aspx.vb" Inherits="E_Management.SchWasteConsignment" 
    title="Untitled Page" %>
            ...
            <td style="height: 110px;" valign="top" align="left" rowspan="" colspan="">
                <table id="TABLE1" onclick="return TABLE1_onclick()" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 307px; height: 28px; background-color: beige;" valign="top">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 307px; background-color: beige; height: 24px;" valign="top">
    ...
    <tr>
        <td align="center" style="width: 131px; height: 249px; text-align: left" valign="top">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddliam"
                    ...
                    <td align="left" colspan="1" style="height: 47px; background-color: beige; width: 109px;" valign="top">
                    </td>
                    </tr>
                    <tr>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="personincharge"
                        ...
                        <td align="left" colspan="1" style="height: 28px; background-color: beige; width: 109px;" valign="top">
                        </td>
                    </tr>
            </table>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
            ...
            &nbsp; &nbsp; &nbsp;&nbsp;<br />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sqlcon1 %>"
                   SelectCommand="SELECT Safety_schedulewasteconsignmentdetails.recordno, Safety_schedulewasteconsignmentdetails.items, Safety_schedulewasteconsignmentdetails.code, safety_schedulemaster.controlspec, safety_schedulemaster.stdmeasurement, safety_schedulemaster.recordno AS Expr1, safety_schedulemaster.Item FROM Safety_schedulewasteconsignmentdetails , safety_schedulemaster  where Safety_schedulewasteconsignmentdetails.items = safety_schedulemaster.Item and Safety_schedulewasteconsignmentdetails.recordno = @rno ">
                    <SelectParameters>
